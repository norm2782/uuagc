...
-- UUAGC 0.9.38.6.5 (src-ag/CodeSyntaxDump.ag)
...
import CodeSyntax
{-# LINE 15 "dist/build/uuagc/uuagc-tmp/CodeSyntaxDump.hs" #-}
...
import Data.Map(Map)
import Data.Set(Set)
{-# LINE 23 "dist/build/uuagc/uuagc-tmp/CodeSyntaxDump.hs" #-}
...
ppStrings = vlist
{-# LINE 58 "dist/build/uuagc/uuagc-tmp/CodeSyntaxDump.hs" #-}
-- CGrammar ----------------------------------------------------
{-
   visit 0:
    ...
    (T_CGrammar (let _lhsOpp :: PP_Doc
                     ...
                     _lhsOpp =
                         ({-# LINE 47 "src-ag/CodeSyntaxDump.ag" #-}
                          ...
                          {-# LINE 117 "src-ag/CodeSyntaxDump.hs" #-}
                          )
    ...
    (T_CInterface (let _lhsOpp :: PP_Doc
                       ...
                       _lhsOpp =
                           ({-# LINE 57 "src-ag/CodeSyntaxDump.ag" #-}
                            ...
                            {-# LINE 156 "src-ag/CodeSyntaxDump.hs" #-}
                            )
                       ( _segIpp,_segIppL) =
                           seg_ 
                   in  ( _lhsOpp)) )
    ...
    (T_CNonterminal (let _lhsOpp :: PP_Doc
                         ...
                         _lhsOpp =
                             ({-# LINE 54 "src-ag/CodeSyntaxDump.ag" #-}
                              ...
                              {-# LINE 206 "src-ag/CodeSyntaxDump.hs" #-}
                              )
    ...
    (T_CNonterminals (let _lhsOppL :: ([PP_Doc])
                          ...
                          _lhsOppL =
                              ({-# LINE 103 "src-ag/CodeSyntaxDump.ag" #-}
                               []
                               {-# LINE 274 "src-ag/CodeSyntaxDump.hs" #-}
                               )
                          -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                          _lhsOpp =
                              ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                               empty
                               {-# LINE 280 "src-ag/CodeSyntaxDump.hs" #-}
                               )
                      in  ( _lhsOpp,_lhsOppL)) )
-- CProduction -------------------------------------------------
{-
    ...
    (T_CProduction (let _lhsOpp :: PP_Doc
                        ...
                        _lhsOpp =
                            ({-# LINE 63 "src-ag/CodeSyntaxDump.ag" #-}
                             ...
                             {-# LINE 323 "src-ag/CodeSyntaxDump.hs" #-}
                             )
    ...
    (T_CProductions (let _lhsOppL :: ([PP_Doc])
                         ...
                         _lhsOppL =
                             ({-# LINE 94 "src-ag/CodeSyntaxDump.ag" #-}
                              _hdIpp : _tlIppL
                              {-# LINE 368 "src-ag/CodeSyntaxDump.hs" #-}
                              )
                         -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                         _lhsOpp =
                             ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                              _hdIpp >-< _tlIpp
                              {-# LINE 374 "src-ag/CodeSyntaxDump.hs" #-}
                              )
                         ( _hdIpp) =
                             hd_ 
                         ( _tlIpp,_tlIppL) =
    ...
    (T_CProductions (let _lhsOppL :: ([PP_Doc])
                         ...
                         _lhsOppL =
                             ({-# LINE 95 "src-ag/CodeSyntaxDump.ag" #-}
                              []
                              {-# LINE 389 "src-ag/CodeSyntaxDump.hs" #-}
                              )
                         -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                         _lhsOpp =
                             ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                              empty
                              {-# LINE 395 "src-ag/CodeSyntaxDump.hs" #-}
                              )
                     in  ( _lhsOpp,_lhsOppL)) )
-- CRule -------------------------------------------------------
{-
    ...
    (T_CRule (let _lhsOpp :: PP_Doc
                  ...
                  _lhsOpp =
                      ({-# LINE 70 "src-ag/CodeSyntaxDump.ag" #-}
                       ...
                       {-# LINE 459 "src-ag/CodeSyntaxDump.hs" #-}
                       )
              in  ( _lhsOpp)) )
    ...
    (T_CRule (let _lhsOpp :: PP_Doc
                  ...
                  _lhsOpp =
                      ({-# LINE 69 "src-ag/CodeSyntaxDump.ag" #-}
                       ...
                       {-# LINE 487 "src-ag/CodeSyntaxDump.hs" #-}
                       )
    ...
    (T_CSegment (let _lhsOpp :: PP_Doc
                     ...
                     _lhsOpp =
                         ({-# LINE 60 "src-ag/CodeSyntaxDump.ag" #-}
                          ...
                          {-# LINE 526 "src-ag/CodeSyntaxDump.hs" #-}
                          )
                 in  ( _lhsOpp)) )
-- CSegments ---------------------------------------------------
{-
    ...
    (T_CSegments (let _lhsOppL :: ([PP_Doc])
                      ...
                      _lhsOppL =
                          ({-# LINE 98 "src-ag/CodeSyntaxDump.ag" #-}
                           _hdIpp : _tlIppL
                           {-# LINE 569 "src-ag/CodeSyntaxDump.hs" #-}
                           )
                      -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                      _lhsOpp =
                          ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                           _hdIpp >-< _tlIpp
                           {-# LINE 575 "src-ag/CodeSyntaxDump.hs" #-}
                           )
                      ( _hdIpp) =
                          hd_ 
                      ( _tlIpp,_tlIppL) =
    ...
    (T_CSegments (let _lhsOppL :: ([PP_Doc])
                      ...
                      _lhsOppL =
                          ({-# LINE 99 "src-ag/CodeSyntaxDump.ag" #-}
                           []
                           {-# LINE 590 "src-ag/CodeSyntaxDump.hs" #-}
                           )
                      -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                      _lhsOpp =
                          ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                           empty
                           {-# LINE 596 "src-ag/CodeSyntaxDump.hs" #-}
                           )
                  in  ( _lhsOpp,_lhsOppL)) )
-- CVisit ------------------------------------------------------
{-
    ...
    (T_CVisit (let _lhsOpp :: PP_Doc
                   ...
                   _lhsOpp =
                       ({-# LINE 66 "src-ag/CodeSyntaxDump.ag" #-}
                        ...
                        {-# LINE 641 "src-ag/CodeSyntaxDump.hs" #-}
                        )
                   ( _vssIppL) =
                       vss_ 
                   ( _intraIppL) =
    ...
    (T_CVisits (let _lhsOppL :: ([PP_Doc])
                    ...
                    _lhsOppL =
                        ({-# LINE 90 "src-ag/CodeSyntaxDump.ag" #-}
                         _hdIpp : _tlIppL
                         {-# LINE 688 "src-ag/CodeSyntaxDump.hs" #-}
                         )
                    -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                         _hdIpp >-< _tlIpp
                         {-# LINE 694 "src-ag/CodeSyntaxDump.hs" #-}
                         )
                    ( _hdIpp) =
                        hd_ 
                    ( _tlIpp,_tlIppL) =
    ...
    (T_CVisits (let _lhsOppL :: ([PP_Doc])
                    ...
                    _lhsOppL =
                        ({-# LINE 91 "src-ag/CodeSyntaxDump.ag" #-}
                         []
                         {-# LINE 709 "src-ag/CodeSyntaxDump.hs" #-}
                         )
                    -- use rule "src-ag/CodeSyntaxDump.ag"(line 44, column 40)
                    _lhsOpp =
                        ({-# LINE 44 "src-ag/CodeSyntaxDump.ag" #-}
                         empty
                         {-# LINE 715 "src-ag/CodeSyntaxDump.hs" #-}
                         )
                in  ( _lhsOpp,_lhsOppL)) )
-- Pattern -----------------------------------------------------
{-
