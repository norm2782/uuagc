...
-- UUAGC 0.9.39.0.0 (src-ag/Visage.ag)
module Visage where
...
import TokenDef
{-# LINE 18 "dist/build/uuagc/uuagc-tmp/Visage.hs" #-}
...
import VisagePatterns
import Expression
{-# LINE 27 "dist/build/uuagc/uuagc-tmp/Visage.hs" #-}

{-# LINE 2 "src-ag/VisagePatterns.ag" #-}

import UU.Scanner.Position(Pos)
import CommonTypes
{-# LINE 33 "dist/build/uuagc/uuagc-tmp/Visage.hs" #-}

{-# LINE 2 "src-ag/Expression.ag" #-}

import UU.Scanner.Position(Pos)
import HsToken
{-# LINE 39 "dist/build/uuagc/uuagc-tmp/Visage.hs" #-}
...
{-# LINE 65 "dist/build/uuagc/uuagc-tmp/Visage.hs" #-}
-- Expression --------------------------------------------------
{-
   visit 0:
                        ...
                        (let _lhsOaterms :: ([ATerm])
                             ...
                             _lhsOaterms =
                                 ({-# LINE 92 "src-ag/Visage.ag" #-}
                                  _hdIaterm : _tlIaterms
                                  {-# LINE 740 "src-ag/Visage.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOisLoc =
                                 ({-# LINE 51 "src-ag/Visage.ag" #-}
                                  _lhsIisLoc
                                  {-# LINE 746 "src-ag/Visage.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOisLoc =
                                 ({-# LINE 51 "src-ag/Visage.ag" #-}
                                  _lhsIisLoc
                                  {-# LINE 752 "src-ag/Visage.hs" #-}
                                  )
                             ( _hdIaterm) =
                                 hd_ _hdOisLoc 
                             ( _tlIaterms) =
