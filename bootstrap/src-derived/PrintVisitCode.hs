...
{-# LINE 27 "dist/build/uuagc/uuagc-tmp/PrintVisitCode.hs" #-}
...
import Data.Map(Map)
import Data.Set(Set)
{-# LINE 35 "dist/build/uuagc/uuagc-tmp/PrintVisitCode.hs" #-}
...
{-# LINE 42 "dist/build/uuagc/uuagc-tmp/PrintVisitCode.hs" #-}

{-# LINE 2 "src-ag/DeclBlocks.ag" #-}

import Code (Decl,Expr)
{-# LINE 47 "dist/build/uuagc/uuagc-tmp/PrintVisitCode.hs" #-}
...
{-# LINE 61 "dist/build/uuagc/uuagc-tmp/PrintVisitCode.hs" #-}
-- CGrammar ----------------------------------------------------
{-
   visit 0:
      inherited attribute:
...
sem_CGrammar_CGrammar typeSyns_ derivings_ wrappers_ (T_CNonterminals nonts_ ) pragmas_ paramMap_ contextMap_ quantMap_ aroundsMap_ mergeMap_ multivisit_  =
    (T_CGrammar (\ _lhsIoptions ->
                     (case (({-# LINE 53 "src-ag/PrintVisitCode.ag" #-}
                             []
                             {-# LINE 115 "src-ag/PrintVisitCode.hs" #-}
                             )) of
                      { _lhsOoutput ->
                      ( _lhsOoutput) })) )
-- CInterface --------------------------------------------------
