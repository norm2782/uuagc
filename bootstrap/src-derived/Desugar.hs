    ...
    (T_Children (\ (!_lhsIinhMap)
                   ...
                   (!_lhsIsynMap) ->
                     (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                             _lhsIinhMap
                             {-# LINE 253 "dist/build/Desugar" #-}
                             )) of
                      { !_tlOinhMap ->
                      (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                              _lhsIinhMap
                              {-# LINE 258 "dist/build/Desugar" #-}
                              )) of
                       { !_hdOinhMap ->
                       (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 263 "dist/build/Desugar" #-}
                               )) of
                        { !_tlOsynMap ->
                        (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                _lhsIoptions
                                {-# LINE 268 "dist/build/Desugar" #-}
                                )) of
                         { !_tlOoptions ->
                         (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                 _lhsImainName
                                 {-# LINE 273 "dist/build/Desugar" #-}
                                 )) of
                          { !_tlOmainName ->
                          (case (tl_ _tlOinhMap _tlOmainName _tlOoptions _tlOsynMap) of
                           { ( !_tlIchildInhs,!_tlIchildSyns,!_tlIoutput) ->
                               (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                       _lhsIsynMap
                                       {-# LINE 280 "dist/build/Desugar" #-}
                                       )) of
                                { !_hdOsynMap ->
                                (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                        _lhsIoptions
                                        {-# LINE 285 "dist/build/Desugar" #-}
                                        )) of
                                 { !_hdOoptions ->
                                 (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                         _lhsImainName
                                         {-# LINE 290 "dist/build/Desugar" #-}
                                         )) of
                                  { !_hdOmainName ->
                                  (case (hd_ _hdOinhMap _hdOmainName _hdOoptions _hdOsynMap) of
                                   { ( !_hdIchildInhs,!_hdIchildSyns,!_hdIoutput) ->
                                       (case (({-# LINE 125 "src-ag/Desugar.ag" #-}
                                               ...
                                               {-# LINE 297 "dist/build/Desugar" #-}
                                               )) of
                                        { !_lhsOchildInhs ->
                                        (case (({-# LINE 125 "src-ag/Desugar.ag" #-}
                                                _hdIchildSyns ++ _tlIchildSyns
                                                {-# LINE 302 "dist/build/Desugar" #-}
                                                )) of
                                         { !_lhsOchildSyns ->
                                         (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                 (:) _hdIoutput _tlIoutput
                                                 {-# LINE 307 "dist/build/Desugar" #-}
                                                 )) of
                                          { !_output ->
                                          (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                  _output
                                                  {-# LINE 312 "dist/build/Desugar" #-}
                                                  )) of
                                           { !_lhsOoutput ->
                                           ( _lhsOchildInhs,_lhsOchildSyns,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
...
sem_Children_Nil =
    (T_Children (\ (!_lhsIinhMap)
                   ...
                   (!_lhsIsynMap) ->
                     (case (({-# LINE 125 "src-ag/Desugar.ag" #-}
                             []
                             {-# LINE 324 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOchildInhs ->
                      (case (({-# LINE 125 "src-ag/Desugar.ag" #-}
                              []
                              {-# LINE 329 "dist/build/Desugar" #-}
                              )) of
                       { !_lhsOchildSyns ->
                       (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                               []
                               {-# LINE 334 "dist/build/Desugar" #-}
                               )) of
                        { !_output ->
                        (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                _output
                                {-# LINE 339 "dist/build/Desugar" #-}
                                )) of
                         { !_lhsOoutput ->
                         ( _lhsOchildInhs,_lhsOchildSyns,_lhsOoutput) }) }) }) })))
-- Expression --------------------------------------------------
    ...
    (T_Expression (\ (!_lhsIchildInhs)
                     ...
                     (!_lhsIruleDescr) ->
                       (case (({-# LINE 49 "src-ag/Desugar.ag" #-}
                               ...
                               {-# LINE 406 "dist/build/Desugar" #-}
                               )) of
                        { !__tup1 ->
                        (case (({-# LINE 49 "src-ag/Desugar.ag" #-}
                                __tup1
                                {-# LINE 411 "dist/build/Desugar" #-}
                                )) of
                         { !(_,!_lhsOerrors) ->
                         (case (({-# LINE 49 "src-ag/Desugar.ag" #-}
                                 __tup1
                                 {-# LINE 416 "dist/build/Desugar" #-}
                                 )) of
                          { !(!_tks',_) ->
                          (case (({-# LINE 59 "src-ag/Desugar.ag" #-}
                                  Expression pos_ _tks'
                                  {-# LINE 421 "dist/build/Desugar" #-}
                                  )) of
                           { !_lhsOoutput ->
                               ...
                               (case (nonts_1 _nontsOaugmentsIn _nontsOforcedIrrefutables _nontsOinhMap _nontsOmainName _nontsOoptions _nontsOsynMap) of
                                { ( !_nontsIallAttributes,!_nontsIaugmentsOut,!_nontsIerrors,!_nontsIoutput) ->
                                    (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                            ...
                                            {-# LINE 526 "dist/build/Desugar" #-}
                                            )) of
                                     { !_lhsOallAttributes ->
                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                             _nontsIerrors
                                             {-# LINE 531 "dist/build/Desugar" #-}
                                             )) of
                                      { !_lhsOerrors ->
    ...
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 79 "src-ag/Desugar.ag" #-}
                            ...
                            {-# LINE 652 "dist/build/Desugar" #-}
                            )) of
                     { !_mField ->
                     (case (({-# LINE 81 "src-ag/Desugar.ag" #-}
                             maybe field_ id _mField
                             {-# LINE 657 "dist/build/Desugar" #-}
                             )) of
                      { !_field' ->
    ...
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 74 "src-ag/Desugar.ag" #-}
                            ...
                            {-# LINE 699 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOaddLines ->
                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                             Seq.empty
                             {-# LINE 704 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOerrors ->
                      (case (({-# LINE 77 "src-ag/Desugar.ag" #-}
                              ...
                              {-# LINE 709 "dist/build/Desugar" #-}
                              )) of
                       { !_tks ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               _tks
                               {-# LINE 714 "dist/build/Desugar" #-}
                               )) of
                        { !_lhsOtks ->
                        ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
    ...
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                            _lhsIaddLines
                            {-# LINE 731 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOaddLines ->
                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                             Seq.empty
                             {-# LINE 736 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOerrors ->
                      (case (({-# LINE 92 "src-ag/Desugar.ag" #-}
                              CharToken value_ (addl _lhsIaddLines pos_)
                              {-# LINE 741 "dist/build/Desugar" #-}
                              )) of
                       { !_tks ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               _tks
                               {-# LINE 746 "dist/build/Desugar" #-}
                               )) of
                        { !_lhsOtks ->
                        ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
...
sem_HsToken_Err !mesg_ !pos_ =
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                            _lhsIaddLines
                            {-# LINE 763 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOaddLines ->
                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                             Seq.empty
                             {-# LINE 768 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOerrors ->
                      (case (({-# LINE 96 "src-ag/Desugar.ag" #-}
                              Err mesg_ (addl _lhsIaddLines pos_)
                              {-# LINE 773 "dist/build/Desugar" #-}
                              )) of
                       { !_tks ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               _tks
                               {-# LINE 778 "dist/build/Desugar" #-}
                               )) of
                        { !_lhsOtks ->
                        ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
...
sem_HsToken_HsToken !value_ !pos_ =
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                            _lhsIaddLines
                            {-# LINE 795 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOaddLines ->
                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                             Seq.empty
                             {-# LINE 800 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOerrors ->
                      (case (({-# LINE 90 "src-ag/Desugar.ag" #-}
                              HsToken value_ (addl _lhsIaddLines pos_)
                              {-# LINE 805 "dist/build/Desugar" #-}
                              )) of
                       { !_tks ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               _tks
                               {-# LINE 810 "dist/build/Desugar" #-}
                               )) of
                        { !_lhsOtks ->
                        ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
...
sem_HsToken_StrToken !value_ !pos_ =
    (T_HsToken (\ (!_lhsIaddLines)
                  ...
                  (!_lhsIuseFieldIdent) ->
                    (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                            _lhsIaddLines
                            {-# LINE 827 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOaddLines ->
                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                             Seq.empty
                             {-# LINE 832 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOerrors ->
                      (case (({-# LINE 94 "src-ag/Desugar.ag" #-}
                              StrToken value_ (addl _lhsIaddLines pos_)
                              {-# LINE 837 "dist/build/Desugar" #-}
                              )) of
                       { !_tks ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               _tks
                               {-# LINE 842 "dist/build/Desugar" #-}
                               )) of
                        { !_lhsOtks ->
                        ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
-- HsTokens ----------------------------------------------------
    ...
    (T_HsTokens (\ (!_lhsIaddLines)
                   ...
                   (!_lhsIuseFieldIdent) ->
                     (case (({-# LINE 62 "src-ag/Desugar.ag" #-}
                             _lhsIuseFieldIdent
                             {-# LINE 906 "dist/build/Desugar" #-}
                             )) of
                      { !_tlOuseFieldIdent ->
                      (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                              _lhsIchildSyns
                              {-# LINE 911 "dist/build/Desugar" #-}
                              )) of
                       { !_tlOchildSyns ->
                       (case (({-# LINE 62 "src-ag/Desugar.ag" #-}
                               _lhsIuseFieldIdent
                               {-# LINE 916 "dist/build/Desugar" #-}
                               )) of
                        { !_hdOuseFieldIdent ->
                        (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                _lhsIchildSyns
                                {-# LINE 921 "dist/build/Desugar" #-}
                                )) of
                         { !_hdOchildSyns ->
                         (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                                 _lhsIaddLines
                                 {-# LINE 926 "dist/build/Desugar" #-}
                                 )) of
                          { !_hdOaddLines ->
                          (case (({-# LINE 168 "src-ag/Desugar.ag" #-}
                                  _lhsIruleDescr
                                  {-# LINE 931 "dist/build/Desugar" #-}
                                  )) of
                           { !_hdOruleDescr ->
                           (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                   _lhsInt
                                   {-# LINE 936 "dist/build/Desugar" #-}
                                   )) of
                            { !_hdOnt ->
                            (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                    _lhsIcon
                                    {-# LINE 941 "dist/build/Desugar" #-}
                                    )) of
                             { !_hdOcon ->
                             (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                     _lhsIchildInhs
                                     {-# LINE 946 "dist/build/Desugar" #-}
                                     )) of
                              { !_hdOchildInhs ->
...
sem_HsTokens_Nil =
    (T_HsTokens (\ (!_lhsIaddLines)
                   ...
                   (!_lhsIuseFieldIdent) ->
                     (case (({-# LINE 64 "src-ag/Desugar.ag" #-}
                             _lhsIaddLines
                             {-# LINE 1010 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOaddLines ->
                      (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                              Seq.empty
                              {-# LINE 1015 "dist/build/Desugar" #-}
                              )) of
                       { !_lhsOerrors ->
                       (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                               []
                               {-# LINE 1020 "dist/build/Desugar" #-}
                               )) of
                        { !_tks ->
                        (case (({-# LINE 70 "src-ag/Desugar.ag" #-}
                                _tks
                                {-# LINE 1025 "dist/build/Desugar" #-}
                                )) of
                         { !_lhsOtks ->
                         ( _lhsOaddLines,_lhsOerrors,_lhsOtks) }) }) }) })))
-- HsTokensRoot ------------------------------------------------
...
sem_HsTokensRoot_HsTokensRoot !(T_HsTokens tokens_) =
    (T_HsTokensRoot (\ (!_lhsIchildInhs)
                       ...
                       (!_lhsIuseFieldIdent) ->
                         (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                 _lhsInt
                                 {-# LINE 1078 "dist/build/Desugar" #-}
                                 )) of
                          { !_tokensOnt ->
                          (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                  _lhsIcon
                                  {-# LINE 1083 "dist/build/Desugar" #-}
                                  )) of
                           { !_tokensOcon ->
                           (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                   _lhsIchildSyns
                                   {-# LINE 1088 "dist/build/Desugar" #-}
                                   )) of
                            { !_tokensOchildSyns ->
                            (case (({-# LINE 62 "src-ag/Desugar.ag" #-}
                                    _lhsIuseFieldIdent
                                    {-# LINE 1093 "dist/build/Desugar" #-}
                                    )) of
                             { !_tokensOuseFieldIdent ->
                             (case (({-# LINE 168 "src-ag/Desugar.ag" #-}
                                     _lhsIruleDescr
                                     {-# LINE 1098 "dist/build/Desugar" #-}
                                     )) of
                              { !_tokensOruleDescr ->
                              (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                      _lhsIchildInhs
                                      {-# LINE 1103 "dist/build/Desugar" #-}
                                      )) of
                               { !_tokensOchildInhs ->
                               (case (({-# LINE 67 "src-ag/Desugar.ag" #-}
                                       0
                                       {-# LINE 1108 "dist/build/Desugar" #-}
                                       )) of
                                { !_tokensOaddLines ->
                                (case (tokens_ _tokensOaddLines _tokensOchildInhs _tokensOchildSyns _tokensOcon _tokensOnt _tokensOruleDescr _tokensOuseFieldIdent) of
                                 { ( !_tokensIaddLines,!_tokensIerrors,!_tokensItks) ->
                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                             _tokensIerrors
                                             {-# LINE 1115 "dist/build/Desugar" #-}
                                             )) of
                                      { !_lhsOerrors ->
                                      (case (({-# LINE 69 "src-ag/Desugar.ag" #-}
                                              _tokensItks
                                              {-# LINE 1120 "dist/build/Desugar" #-}
                                              )) of
                                       { !_lhsOtks ->
...
sem_Nonterminal_Nonterminal !nt_ !params_ !inh_ !syn_ !(T_Productions prods_) =
    (T_Nonterminal (case (({-# LINE 7 "src-ag/DistChildAttr.ag" #-}
                           ...
                           {-# LINE 1187 "dist/build/Desugar" #-}
                           )) of
                    { !_lhsOinhMap' ->
                    (case (({-# LINE 8 "src-ag/DistChildAttr.ag" #-}
                            Map.singleton nt_ syn_
                            {-# LINE 1192 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOsynMap' ->
                                     ...
                                     (T_Nonterminal_1 (\ (!_lhsIaugmentsIn)
                                                         ...
                                                         (!_lhsIsynMap) ->
                                                           (case (({-# LINE 157 "src-ag/Desugar.ag" #-}
                                                                   nt_
                                                                   {-# LINE 1205 "dist/build/Desugar" #-}
                                                                   )) of
                                                            { !_prodsOnt ->
                                                            (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                                    _lhsIsynMap
                                                                    {-# LINE 1210 "dist/build/Desugar" #-}
                                                                    )) of
                                                             { !_prodsOsynMap ->
                                                             (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                     _lhsIoptions
                         ...
                         (case (hd_) of
                          { ( !_hdIinhMap',!_hdIsynMap',!T_Nonterminal_1 hd_1) ->
                              (case (({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                      ...
                                      {-# LINE 1345 "dist/build/Desugar" #-}
                                      )) of
                               { !_lhsOinhMap' ->
                               (case (({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                                       _hdIsynMap' `Map.union` _tlIsynMap'
                                       {-# LINE 1350 "dist/build/Desugar" #-}
                                       )) of
                                { !_lhsOsynMap' ->
                                            ...
                                            sem_Nonterminals_Cons_1 =
                                                (T_Nonterminals_1 (\ (!_lhsIaugmentsIn)
                                                                     ...
                                                                     (!_lhsIsynMap) ->
                                                                       (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                                               _lhsIsynMap
                                                                               {-# LINE 1363 "dist/build/Desugar" #-}
                                                                               )) of
                                                                        { !_tlOsynMap ->
                                                                        (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                                _lhsIoptions
                                                                                {-# LINE 1368 "dist/build/Desugar" #-}
                                                                                )) of
                                                                         { !_tlOoptions ->
                                                                         (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                                                                 _lhsImainName
                                                                          ...
                                                                          (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                                           ...
                                                                           (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                                   _lhsIforcedIrrefutables
                                                                                   {-# LINE 1383 "dist/build/Desugar" #-}
                                                                                   )) of
                                                                            { !_tlOforcedIrrefutables ->
                                                                            (case (({-# LINE 228 "src-ag/Desugar.ag" #-}
                                                                                    _lhsIaugmentsIn
                                                                                    {-# LINE 1388 "dist/build/Desugar" #-}
                                                                                    )) of
                                                                             { !_tlOaugmentsIn ->
                                                                             (case (tl_1 _tlOaugmentsIn _tlOforcedIrrefutables _tlOinhMap _tlOmainName _tlOoptions _tlOsynMap) of
                                                                              { ( !_tlIallAttributes,!_tlIaugmentsOut,!_tlIerrors,!_tlIoutput) ->
                                                                                  (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                                                          _lhsIsynMap
                                                                                          {-# LINE 1395 "dist/build/Desugar" #-}
                                                                                          )) of
                                                                                   { !_hdOsynMap ->
                                                                                   (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                                           _lhsIoptions
                                                                                           {-# LINE 1400 "dist/build/Desugar" #-}
                                                                                           )) of
                                                                                    { !_hdOoptions ->
                                                                                    (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                                                                            _lhsImainName
                                                                                            {-# LINE 1405 "dist/build/Desugar" #-}
                                                                                            )) of
                                                                                     { !_hdOmainName ->
                                                                                     (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                                                             _lhsIinhMap
                                                                                             {-# LINE 1410 "dist/build/Desugar" #-}
                                                                                             )) of
                                                                                      { !_hdOinhMap ->
                                                                                      (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                                              _lhsIforcedIrrefutables
                                                                                              {-# LINE 1415 "dist/build/Desugar" #-}
                                                                                              )) of
                                                                                       { !_hdOforcedIrrefutables ->
                                                                                       (case (({-# LINE 228 "src-ag/Desugar.ag" #-}
                                                                                               _lhsIaugmentsIn
                                                                                               {-# LINE 1420 "dist/build/Desugar" #-}
                                                                                               )) of
                                                                                        { !_hdOaugmentsIn ->
                                                                                        (case (hd_1 _hdOaugmentsIn _hdOforcedIrrefutables _hdOinhMap _hdOmainName _hdOoptions _hdOsynMap) of
                                                                                         { ( !_hdIallAttributes,!_hdIaugmentsOut,!_hdIerrors,!_hdIoutput) ->
                                                                                             (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                                                     ...
                                                                                                     {-# LINE 1427 "dist/build/Desugar" #-}
                                                                                                     )) of
                                                                                              { !_lhsOallAttributes ->
                                                                                              (case (({-# LINE 229 "src-ag/Desugar.ag" #-}
                                                                                                      _hdIaugmentsOut `Map.union` _tlIaugmentsOut
                                                                                                      {-# LINE 1432 "dist/build/Desugar" #-}
                                                                                                      )) of
                                                                                               { !_lhsOaugmentsOut ->
                                                                                               (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                                                       _hdIerrors Seq.>< _tlIerrors
                                                                                                       {-# LINE 1437 "dist/build/Desugar" #-}
                                                                                                       )) of
                                                                                                { !_lhsOerrors ->
                                                                                                (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                                        (:) _hdIoutput _tlIoutput
                                                                                                        {-# LINE 1442 "dist/build/Desugar" #-}
                                                                                                        )) of
                                                                                                 { !_output ->
                                                                                                 (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                                         _output
                                                                                                         {-# LINE 1447 "dist/build/Desugar" #-}
                                                                                                         )) of
                                                                                                  { !_lhsOoutput ->
                                                                                                  ( _lhsOallAttributes,_lhsOaugmentsOut,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
...
sem_Nonterminals_Nil =
    (T_Nonterminals (case (({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                            Map.empty
                            {-# LINE 1458 "dist/build/Desugar" #-}
                            )) of
                     { !_lhsOinhMap' ->
                     (case (({-# LINE 4 "src-ag/DistChildAttr.ag" #-}
                             Map.empty
                             {-# LINE 1463 "dist/build/Desugar" #-}
                             )) of
                      { !_lhsOsynMap' ->
                                  ...
                                  sem_Nonterminals_Nil_1 =
                                      (T_Nonterminals_1 (\ (!_lhsIaugmentsIn)
                                                           ...
                                                           (!_lhsIsynMap) ->
                                                             (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                     Map.empty
                                                                     {-# LINE 1476 "dist/build/Desugar" #-}
                                                                     )) of
                                                              { !_lhsOallAttributes ->
                                                              (case (({-# LINE 229 "src-ag/Desugar.ag" #-}
                                                                      Map.empty
                                                                      {-# LINE 1481 "dist/build/Desugar" #-}
                                                                      )) of
                                                               { !_lhsOaugmentsOut ->
                                                               (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                       Seq.empty
                                  ...
                                  sem_Pattern_Alias_1 =
                                      (T_Pattern_1 (\ (!_lhsIchildInhs)
                                                      ...
                                                      (!_lhsInt) ->
                                                        (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                _lhsInt
                                                                {-# LINE 1616 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_patOnt ->
                                                         (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                 _lhsIcon
                                                                 {-# LINE 1621 "dist/build/Desugar" #-}
                                                                 )) of
                                                          { !_patOcon ->
                                                          (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                  _lhsIforcedIrrefutables
                                                                  {-# LINE 1626 "dist/build/Desugar" #-}
                                                                  )) of
                                                           ...
                                                           (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                            ...
                                                            (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                    _lhsIchildSyns
                                                                    {-# LINE 1636 "dist/build/Desugar" #-}
                                                                    )) of
                                                             { !_patOchildSyns ->
                                                             (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                     _lhsIchildInhs
                                                                     {-# LINE 1641 "dist/build/Desugar" #-}
                                                                     )) of
                                                              { !_patOchildInhs ->
                                                              (case (pat_1 _patOchildInhs _patOchildSyns _patOcon _patOdefs _patOforcedIrrefutables _patOnt) of
                                                               { ( !_patIallAttributes,!_patIcopy,!_patIerrors,!_patIoutput) ->
                                                                   (case (({-# LINE 200 "src-ag/Desugar.ag" #-}
                                                                           ...
                                                                           {-# LINE 1648 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_lhsOallAttributes ->
                                                                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                            Alias field_ attr_ _patIcopy
                                                                            {-# LINE 1653 "dist/build/Desugar" #-}
                                                                            )) of
                                                                     { !_copy ->
                                                                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                             _copy
                                                                             {-# LINE 1658 "dist/build/Desugar" #-}
                                                                             )) of
                                                                      { !_lhsOcopy ->
                                     ...
                                     (T_Pattern_1 (\ (!_lhsIchildInhs)
                                                     ...
                                                     (!_lhsInt) ->
                                                       (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                        ...
                                                        (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                _lhsIcon
                                                                {-# LINE 1733 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_patsOcon ->
                                                         (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                 _lhsIforcedIrrefutables
                                                                 {-# LINE 1738 "dist/build/Desugar" #-}
                                                                 )) of
                                                          ...
                                                          (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                           ...
                                                           (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                   _lhsIchildSyns
                                                                   {-# LINE 1748 "dist/build/Desugar" #-}
                                                                   )) of
                                                            { !_patsOchildSyns ->
                                                            (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                    _lhsIchildInhs
                                                                    {-# LINE 1753 "dist/build/Desugar" #-}
                                                                    )) of
                                                             { !_patsOchildInhs ->
                                                             (case (pats_1 _patsOchildInhs _patsOchildSyns _patsOcon _patsOdefs _patsOforcedIrrefutables _patsOnt) of
                                                              { ( !_patsIallAttributes,!_patsIcopy,!_patsIerrors,!_patsIoutput) ->
                                                                  (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                          _patsIallAttributes
                                                                          {-# LINE 1760 "dist/build/Desugar" #-}
                                                                          )) of
                                                                   { !_lhsOallAttributes ->
                                                                   (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                           Constr name_ _patsIcopy
                                                                           {-# LINE 1765 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_copy ->
                                                                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                            _copy
                                                                            {-# LINE 1770 "dist/build/Desugar" #-}
                                                                            )) of
                                                                     { !_lhsOcopy ->
                                                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                             _patsIerrors
                                                                             {-# LINE 1775 "dist/build/Desugar" #-}
                                                                             )) of
                                                                      { !_lhsOerrors ->
                                                                      (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                              Constr name_ _patsIoutput
                                                                              {-# LINE 1780 "dist/build/Desugar" #-}
                                                                              )) of
                                                                       { !_output ->
                                                                       (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                               _output
                                                                               {-# LINE 1785 "dist/build/Desugar" #-}
                                                                               )) of
                                                                        { !_lhsOoutput ->
                                                                        ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) })))
                                     ...
                                     (T_Pattern_1 (\ (!_lhsIchildInhs)
                                                     ...
                                                     (!_lhsInt) ->
                                                       (case (({-# LINE 202 "src-ag/Desugar.ag" #-}
                                                               Map.empty
                                                               {-# LINE 1812 "dist/build/Desugar" #-}
                                                               )) of
                                                        { !_lhsOallAttributes ->
                                                        (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                _lhsInt
                                                                {-# LINE 1817 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_patOnt ->
                                                         (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                 _lhsIforcedIrrefutables
                                                                 {-# LINE 1822 "dist/build/Desugar" #-}
                                                                 )) of
                                                          { !_patOforcedIrrefutables ->
                                                          (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                  _lhsIdefs
                                                           ...
                                                           (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                   _lhsIcon
                                                                   {-# LINE 1832 "dist/build/Desugar" #-}
                                                                   )) of
                                                            { !_patOcon ->
                                                            (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                    _lhsIchildSyns
                                                                    {-# LINE 1837 "dist/build/Desugar" #-}
                                                                    )) of
                                                             { !_patOchildSyns ->
                                                             (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                     _lhsIchildInhs
                                                                     {-# LINE 1842 "dist/build/Desugar" #-}
                                                                     )) of
                                                              { !_patOchildInhs ->
                                                              (case (pat_1 _patOchildInhs _patOchildSyns _patOcon _patOdefs _patOforcedIrrefutables _patOnt) of
                                                               { ( !_patIallAttributes,!_patIcopy,!_patIerrors,!_patIoutput) ->
                                                                   (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                           ...
                                                                           {-# LINE 1849 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_copy ->
                                                                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                            _copy
                                                                            {-# LINE 1854 "dist/build/Desugar" #-}
                                                                            )) of
                                                                     { !_lhsOcopy ->
                                                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                             _patIerrors
                                                                             {-# LINE 1859 "dist/build/Desugar" #-}
                                                                             )) of
                                                                      { !_lhsOerrors ->
                                                                      (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                              Irrefutable _patIoutput
                                                                              {-# LINE 1864 "dist/build/Desugar" #-}
                                                                              )) of
                                                                       { !_output ->
                                                                       (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                               _output
                                                                               {-# LINE 1869 "dist/build/Desugar" #-}
                                                                               )) of
                                                                        { !_lhsOoutput ->
                                                                        ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) })))
                                     ...
                                     (T_Pattern_1 (\ (!_lhsIchildInhs)
                                                     ...
                                                     (!_lhsInt) ->
                                                       (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                        ...
                                                        (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                _lhsIcon
                                                                {-# LINE 1902 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_patsOcon ->
                                                         (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                 _lhsIforcedIrrefutables
                                                                 {-# LINE 1907 "dist/build/Desugar" #-}
                                                                 )) of
                                                          { !_patsOforcedIrrefutables ->
                                                          (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                  _lhsIdefs
                                                           ...
                                                           (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                   _lhsIchildSyns
                                                                   {-# LINE 1917 "dist/build/Desugar" #-}
                                                                   )) of
                                                            { !_patsOchildSyns ->
                                                            (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                    _lhsIchildInhs
                                                                    {-# LINE 1922 "dist/build/Desugar" #-}
                                                                    )) of
                                                             { !_patsOchildInhs ->
                                                             (case (pats_1 _patsOchildInhs _patsOchildSyns _patsOcon _patsOdefs _patsOforcedIrrefutables _patsOnt) of
                                                              { ( !_patsIallAttributes,!_patsIcopy,!_patsIerrors,!_patsIoutput) ->
                                                                  (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                          _patsIallAttributes
                                                                          {-# LINE 1929 "dist/build/Desugar" #-}
                                                                          )) of
                                                                   { !_lhsOallAttributes ->
                                                                   (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                           Product pos_ _patsIcopy
                                                                           {-# LINE 1934 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_copy ->
                                                                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                            _copy
                                                                            {-# LINE 1939 "dist/build/Desugar" #-}
                                                                            )) of
                                                                     { !_lhsOcopy ->
                                                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                             _patsIerrors
                                                                             {-# LINE 1944 "dist/build/Desugar" #-}
                                                                             )) of
                                                                      { !_lhsOerrors ->
                                                                      (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                              Product pos_ _patsIoutput
                                                                              {-# LINE 1949 "dist/build/Desugar" #-}
                                                                              )) of
                                                                       { !_output ->
                                                                       (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                               _output
                                                                               {-# LINE 1954 "dist/build/Desugar" #-}
                                                                               )) of
                                                                        { !_lhsOoutput ->
                                                                        ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) })))
                            ...
                            sem_Pattern_Underscore_1 =
                                (T_Pattern_1 (\ (!_lhsIchildInhs)
                                                ...
                                                (!_lhsInt) ->
                                                  (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                          Map.empty
                                                          {-# LINE 1979 "dist/build/Desugar" #-}
                                                          )) of
                                                   { !_lhsOallAttributes ->
                                                   (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                           Underscore pos_
                                                           {-# LINE 1984 "dist/build/Desugar" #-}
                                                           )) of
                                                    { !_copy ->
                                                    (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                            _copy
                                                            {-# LINE 1989 "dist/build/Desugar" #-}
                                                            )) of
                                                     { !_lhsOcopy ->
                                                     (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                             Seq.empty
                                                      ...
                                                      (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                              Underscore pos_
                                                              {-# LINE 1999 "dist/build/Desugar" #-}
                                                              )) of
                                                       { !_output ->
                                                       (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                               _output
                                                               {-# LINE 2004 "dist/build/Desugar" #-}
                                                               )) of
                                                        { !_lhsOoutput ->
                                                        ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) })))
                                       ...
                                       sem_Patterns_Cons_1 =
                                           (T_Patterns_1 (\ (!_lhsIchildInhs)
                                                            ...
                                                            (!_lhsInt) ->
                                                              (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                      _lhsInt
                                                                      {-# LINE 2087 "dist/build/Desugar" #-}
                                                                      )) of
                                                               { !_tlOnt ->
                                                               (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                       _lhsIcon
                                                                       {-# LINE 2092 "dist/build/Desugar" #-}
                                                                       )) of
                                                                { !_tlOcon ->
                                                                (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                        _lhsInt
                                                                        {-# LINE 2097 "dist/build/Desugar" #-}
                                                                        )) of
                                                                 { !_hdOnt ->
                                                                 (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                         _lhsIcon
                                                                  ...
                                                                  (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                          _lhsIforcedIrrefutables
                                                                          {-# LINE 2107 "dist/build/Desugar" #-}
                                                                          )) of
                                                                   { !_tlOforcedIrrefutables ->
                                                                   (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                           _lhsIdefs
                                                                           {-# LINE 2112 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_tlOdefs ->
                                                                    (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                            _lhsIchildSyns
                                                                            {-# LINE 2117 "dist/build/Desugar" #-}
                                                                            )) of
                                                                     { !_tlOchildSyns ->
                                                                     (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                             _lhsIchildInhs
                                                                             {-# LINE 2122 "dist/build/Desugar" #-}
                                                                             )) of
                                                                      { !_tlOchildInhs ->
                                                                      (case (tl_1 _tlOchildInhs _tlOchildSyns _tlOcon _tlOdefs _tlOforcedIrrefutables _tlOnt) of
                                                                       { ( !_tlIallAttributes,!_tlIcopy,!_tlIerrors,!_tlIoutput) ->
                                                                           (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                                   _lhsIforcedIrrefutables
                                                                                   {-# LINE 2129 "dist/build/Desugar" #-}
                                                                                   )) of
                                                                            { !_hdOforcedIrrefutables ->
                                                                            (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                                    _lhsIdefs
                                                                                    {-# LINE 2134 "dist/build/Desugar" #-}
                                                                                    )) of
                                                                             { !_hdOdefs ->
                                                                             (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                                     _lhsIchildSyns
                                                                                     {-# LINE 2139 "dist/build/Desugar" #-}
                                                                                     )) of
                                                                              { !_hdOchildSyns ->
                                                                              (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                                      _lhsIchildInhs
                                                                                      {-# LINE 2144 "dist/build/Desugar" #-}
                                                                                      )) of
                                                                               { !_hdOchildInhs ->
                                                                               (case (hd_1 _hdOchildInhs _hdOchildSyns _hdOcon _hdOdefs _hdOforcedIrrefutables _hdOnt) of
                                                                                { ( !_hdIallAttributes,!_hdIcopy,!_hdIerrors,!_hdIoutput) ->
                                                                                    (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                                            _hdIallAttributes `mergeAttributes` _tlIallAttributes
                                                                                            {-# LINE 2151 "dist/build/Desugar" #-}
                                                                                            )) of
                                                                                     { !_lhsOallAttributes ->
                                                                                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                                             (:) _hdIcopy _tlIcopy
                                                                                             {-# LINE 2156 "dist/build/Desugar" #-}
                                                                                             )) of
                                                                                      { !_copy ->
                                                                                      (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                                                              _copy
                                                                                              {-# LINE 2161 "dist/build/Desugar" #-}
                                                                                              )) of
                                                                                       { !_lhsOcopy ->
                                                                                       (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                                               _hdIerrors Seq.>< _tlIerrors
                                                                                               {-# LINE 2166 "dist/build/Desugar" #-}
                                                                                               )) of
                                                                                        { !_lhsOerrors ->
                                                                                        (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                                (:) _hdIoutput _tlIoutput
                                                                                                {-# LINE 2171 "dist/build/Desugar" #-}
                                                                                                )) of
                                                                                         { !_output ->
                                                                                         (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                                 _output
                                                                                                 {-# LINE 2176 "dist/build/Desugar" #-}
                                                                                                 )) of
                                                                                          { !_lhsOoutput ->
                                                                                          ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
                             ...
                             sem_Patterns_Nil_1 =
                                 (T_Patterns_1 (\ (!_lhsIchildInhs)
                                                  ...
                                                  (!_lhsInt) ->
                                                    (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                            Map.empty
                                                            {-# LINE 2200 "dist/build/Desugar" #-}
                                                            )) of
                                                     { !_lhsOallAttributes ->
                                                     (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                             []
                                                             {-# LINE 2205 "dist/build/Desugar" #-}
                                                             )) of
                                                      { !_copy ->
                                                      (case (({-# LINE 22 "src-ag/Patterns.ag" #-}
                                                              _copy
                                                              {-# LINE 2210 "dist/build/Desugar" #-}
                                                              )) of
                                                       { !_lhsOcopy ->
                                                       (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                               Seq.empty
                                                        ...
                                                        (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                []
                                                                {-# LINE 2220 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_output ->
                                                         (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                 _output
                                                                 {-# LINE 2225 "dist/build/Desugar" #-}
                                                                 )) of
                                                          { !_lhsOoutput ->
                                                          ( _lhsOallAttributes,_lhsOcopy,_lhsOerrors,_lhsOoutput) }) }) }) }) }) })))
...
sem_Production_Production !con_ !params_ !constraints_ !(T_Children children_) !(T_Rules rules_) !(T_TypeSigs typeSigs_) !macro_ =
    (T_Production (\ (!_lhsIaugmentsIn)
                     ...
                     (!_lhsIsynMap) ->
                       (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                               _lhsInt
                               {-# LINE 2305 "dist/build/Desugar" #-}
                               )) of
                        { !_rulesOnt ->
                        (case (({-# LINE 161 "src-ag/Desugar.ag" #-}
                                con_
                                {-# LINE 2310 "dist/build/Desugar" #-}
                                )) of
                         { !_rulesOcon ->
                         (case (rules_) of
                          { ( !_rulesIdefsCollect,!T_Rules_1 rules_1) ->
                              (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                      _lhsIoptions
                                      {-# LINE 2317 "dist/build/Desugar" #-}
                                      )) of
                               { !_rulesOoptions ->
                               (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                       _lhsIforcedIrrefutables
                                       {-# LINE 2322 "dist/build/Desugar" #-}
                                       )) of
                                { !_rulesOforcedIrrefutables ->
                                (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                        _lhsIsynMap
                                        {-# LINE 2327 "dist/build/Desugar" #-}
                                        )) of
                                 { !_childrenOsynMap ->
                                 (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                         _lhsIoptions
                                         {-# LINE 2332 "dist/build/Desugar" #-}
                                         )) of
                                  { !_childrenOoptions ->
                                  (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                          _lhsImainName
                                          {-# LINE 2337 "dist/build/Desugar" #-}
                                          )) of
                                   { !_childrenOmainName ->
                                   (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                           _lhsIinhMap
                                           {-# LINE 2342 "dist/build/Desugar" #-}
                                           )) of
                                    { !_childrenOinhMap ->
                                    (case (children_ _childrenOinhMap _childrenOmainName _childrenOoptions _childrenOsynMap) of
                                     { ( !_childrenIchildInhs,!_childrenIchildSyns,!_childrenIoutput) ->
                                         (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                 _childrenIchildSyns
                                                 {-# LINE 2349 "dist/build/Desugar" #-}
                                                 )) of
                                          { !_rulesOchildSyns ->
                                          (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                  _childrenIchildInhs
                                                  {-# LINE 2354 "dist/build/Desugar" #-}
                                                  )) of
                                           { !_rulesOchildInhs ->
                                           (case (({-# LINE 188 "src-ag/Desugar.ag" #-}
                                                   _rulesIdefsCollect
                                                   {-# LINE 2359 "dist/build/Desugar" #-}
                                                   )) of
                                            { !_rulesOdefs ->
                                                 ...
                                                 (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                  ...
                                                  (case (({-# LINE 244 "src-ag/Desugar.ag" #-}
                                                   ...
                                                   (case (({-# LINE 247 "src-ag/Desugar.ag" #-}
                                                           ...
                                                           {-# LINE 2376 "dist/build/Desugar" #-}
                                                           )) of
                                                    { !__tup3 ->
                                                    (case (({-# LINE 247 "src-ag/Desugar.ag" #-}
                                                            __tup3
                                                            {-# LINE 2381 "dist/build/Desugar" #-}
                                                            )) of
                                                     { !(_,!_augmentsOut1) ->
                                                     (case (({-# LINE 245 "src-ag/Desugar.ag" #-}
                                                             Map.singleton con_ _augmentsOut1
                                                             {-# LINE 2386 "dist/build/Desugar" #-}
                                                             )) of
                                                      { !_augmentsOut ->
                                                      (case (({-# LINE 231 "src-ag/Desugar.ag" #-}
                                                              _augmentsOut
                                                              {-# LINE 2391 "dist/build/Desugar" #-}
                                                              )) of
                                                       { !_lhsOaugmentsOut ->
                                                       (case (({-# LINE 247 "src-ag/Desugar.ag" #-}
                                                               __tup3
                                                               {-# LINE 2396 "dist/build/Desugar" #-}
                                                               )) of
                                                        { !(!_augmentErrs,_) ->
                                                        (case (({-# LINE 283 "src-ag/Desugar.ag" #-}
                                                                _rulesIerrors Seq.>< _augmentErrs
                                                                {-# LINE 2401 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_lhsOerrors ->
                                                         (case (typeSigs_) of
                                                          { ( !_typeSigsIoutput) ->
                                                              (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                      ...
                                                                      {-# LINE 2408 "dist/build/Desugar" #-}
                                                                      )) of
                                                               { !_output ->
                                                               (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                       _output
                                                                       {-# LINE 2413 "dist/build/Desugar" #-}
                                                                       )) of
                                                                { !_lhsOoutput ->
                                                                ( _lhsOallAttributes,_lhsOaugmentsOut,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
-- Productions -------------------------------------------------
...
sem_Productions_Cons !(T_Production hd_) !(T_Productions tl_) =
    (T_Productions (\ (!_lhsIaugmentsIn)
                      ...
                      (!_lhsIsynMap) ->
                        (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                _lhsInt
                                {-# LINE 2478 "dist/build/Desugar" #-}
                                )) of
                         { !_tlOnt ->
                         (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                 _lhsInt
                                 {-# LINE 2483 "dist/build/Desugar" #-}
                                 )) of
                          { !_hdOnt ->
                          (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 2488 "dist/build/Desugar" #-}
                                  )) of
                           { !_tlOsynMap ->
                           (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                   _lhsIoptions
                                   {-# LINE 2493 "dist/build/Desugar" #-}
                                   )) of
                            { !_tlOoptions ->
                            (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                    _lhsImainName
                                    {-# LINE 2498 "dist/build/Desugar" #-}
                                    )) of
                             { !_tlOmainName ->
                             (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                     _lhsIinhMap
                                     {-# LINE 2503 "dist/build/Desugar" #-}
                                     )) of
                              { !_tlOinhMap ->
                              (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                      _lhsIforcedIrrefutables
                               ...
                               (case (({-# LINE 230 "src-ag/Desugar.ag" #-}
                                ...
                                (case (tl_ _tlOaugmentsIn _tlOforcedIrrefutables _tlOinhMap _tlOmainName _tlOnt _tlOoptions _tlOsynMap) of
                                 { ( !_tlIallAttributes,!_tlIaugmentsOut,!_tlIerrors,!_tlIoutput) ->
                                     (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                             _lhsIsynMap
                                             {-# LINE 2520 "dist/build/Desugar" #-}
                                             )) of
                                      { !_hdOsynMap ->
                                      (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                              _lhsIoptions
                                              {-# LINE 2525 "dist/build/Desugar" #-}
                                              )) of
                                       { !_hdOoptions ->
                                       (case (({-# LINE 289 "src-ag/Desugar.ag" #-}
                                               _lhsImainName
                                               {-# LINE 2530 "dist/build/Desugar" #-}
                                               )) of
                                        { !_hdOmainName ->
                                        (case (({-# LINE 12 "src-ag/DistChildAttr.ag" #-}
                                                _lhsIinhMap
                                                {-# LINE 2535 "dist/build/Desugar" #-}
                                                )) of
                                         { !_hdOinhMap ->
                                         (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                 _lhsIforcedIrrefutables
                                                 {-# LINE 2540 "dist/build/Desugar" #-}
                                                 )) of
                                          { !_hdOforcedIrrefutables ->
                                          (case (({-# LINE 230 "src-ag/Desugar.ag" #-}
                                                  _lhsIaugmentsIn
                                                  {-# LINE 2545 "dist/build/Desugar" #-}
                                                  )) of
                                           { !_hdOaugmentsIn ->
                                           (case (hd_ _hdOaugmentsIn _hdOforcedIrrefutables _hdOinhMap _hdOmainName _hdOnt _hdOoptions _hdOsynMap) of
                                            { ( !_hdIallAttributes,!_hdIaugmentsOut,!_hdIerrors,!_hdIoutput) ->
                                                (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                        _hdIallAttributes `mergeAttributes` _tlIallAttributes
                                                        {-# LINE 2552 "dist/build/Desugar" #-}
                                                        )) of
                                                 { !_lhsOallAttributes ->
                                                 (case (({-# LINE 231 "src-ag/Desugar.ag" #-}
                                                         _hdIaugmentsOut `Map.union` _tlIaugmentsOut
                                                         {-# LINE 2557 "dist/build/Desugar" #-}
                                                         )) of
                                                  { !_lhsOaugmentsOut ->
                                                  (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                          _hdIerrors Seq.>< _tlIerrors
                                                          {-# LINE 2562 "dist/build/Desugar" #-}
                                                          )) of
                                                   { !_lhsOerrors ->
                                                   (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                           (:) _hdIoutput _tlIoutput
                                                           {-# LINE 2567 "dist/build/Desugar" #-}
                                                           )) of
                                                    { !_output ->
                                                    (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                            _output
                                                            {-# LINE 2572 "dist/build/Desugar" #-}
                                                            )) of
                                                     { !_lhsOoutput ->
                                                     ( _lhsOallAttributes,_lhsOaugmentsOut,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
                              ...
                              sem_Rule_Rule_1 =
                                  (T_Rule_1 (\ (!_lhsIchildInhs)
                                               ...
                                               (!_lhsIoptions) ->
                                                 (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                         _lhsInt
                                                         {-# LINE 2699 "dist/build/Desugar" #-}
                                                         )) of
                                                  { !_patternOnt ->
                                                  (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                          _lhsIcon
                                                          {-# LINE 2704 "dist/build/Desugar" #-}
                                                          )) of
                                                   { !_patternOcon ->
                                                   (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                           _lhsIforcedIrrefutables
                                                           {-# LINE 2709 "dist/build/Desugar" #-}
                                                           )) of
                                                    { !_patternOforcedIrrefutables ->
                                                    (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                            _lhsIdefs
                                                            {-# LINE 2714 "dist/build/Desugar" #-}
                                                            )) of
                                                     { !_patternOdefs ->
                                                     (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                             _lhsIchildSyns
                                                        ...
                                                        { ( !_patternIallAttributes,!_patternIcopy,!_patternIerrors,!_patternIoutput) ->
                                                            (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                             ...
                                                             (case (({-# LINE 172 "src-ag/Desugar.ag" #-}
                                                                     ...
                                                                     {-# LINE 2736 "dist/build/Desugar" #-}
                                                                     )) of
                                                              { !_ruleDescr ->
                                                              (case (({-# LINE 168 "src-ag/Desugar.ag" #-}
                                                                      _ruleDescr
                                                                      {-# LINE 2741 "dist/build/Desugar" #-}
                                                                      )) of
                                                               { !_rhsOruleDescr ->
                                                               (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                       _lhsIoptions
                                                                       {-# LINE 2746 "dist/build/Desugar" #-}
                                                                       )) of
                                                                { !_rhsOoptions ->
                                                                (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                        _lhsInt
                                                                        {-# LINE 2751 "dist/build/Desugar" #-}
                                                                        )) of
                                                                 { !_rhsOnt ->
                                                                 (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                         _lhsIcon
                                                                         {-# LINE 2756 "dist/build/Desugar" #-}
                                                                         )) of
                                                                  { !_rhsOcon ->
                                                                  (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                          _lhsIchildSyns
                                                                          {-# LINE 2761 "dist/build/Desugar" #-}
                                                                          )) of
                                                                   { !_rhsOchildSyns ->
                                                                   (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                           _lhsIchildInhs
                                                                           {-# LINE 2766 "dist/build/Desugar" #-}
                                                                           )) of
                                                                    { !_rhsOchildInhs ->
                                    ...
                                    sem_Rules_Cons_1 =
                                        (T_Rules_1 (\ (!_lhsIchildInhs)
                                                      ...
                                                      (!_lhsIoptions) ->
                                                        (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                _lhsInt
                                                                {-# LINE 2866 "dist/build/Desugar" #-}
                                                                )) of
                                                         { !_tlOnt ->
                                                         (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                 _lhsIcon
                                                                 {-# LINE 2871 "dist/build/Desugar" #-}
                                                                 )) of
                                                          { !_tlOcon ->
                                                          (case (({-# LINE 152 "src-ag/Desugar.ag" #-}
                                                                  _lhsInt
                                                                  {-# LINE 2876 "dist/build/Desugar" #-}
                                                                  )) of
                                                           { !_hdOnt ->
                                                           (case (({-# LINE 153 "src-ag/Desugar.ag" #-}
                                                                   _lhsIcon
                                                                   {-# LINE 2881 "dist/build/Desugar" #-}
                                                                   )) of
                                                            { !_hdOcon ->
                                                            (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                    _lhsIoptions
                                                             ...
                                                             (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                     _lhsIforcedIrrefutables
                                                                     {-# LINE 2891 "dist/build/Desugar" #-}
                                                                     )) of
                                                              { !_tlOforcedIrrefutables ->
                                                              (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                      _lhsIdefs
                                                                      {-# LINE 2896 "dist/build/Desugar" #-}
                                                                      )) of
                                                               { !_tlOdefs ->
                                                               (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                       _lhsIchildSyns
                                                                       {-# LINE 2901 "dist/build/Desugar" #-}
                                                                       )) of
                                                                { !_tlOchildSyns ->
                                                                (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                        _lhsIchildInhs
                                                                        {-# LINE 2906 "dist/build/Desugar" #-}
                                                                        )) of
                                                                 { !_tlOchildInhs ->
                                                                 (case (tl_1 _tlOchildInhs _tlOchildSyns _tlOcon _tlOdefs _tlOforcedIrrefutables _tlOnt _tlOoptions) of
                                                                  { ( !_tlIallAttributes,!_tlIerrors,!_tlIoutput) ->
                                                                      (case (({-# LINE 36 "src-ag/Desugar.ag" #-}
                                                                              _lhsIoptions
                                                                              {-# LINE 2913 "dist/build/Desugar" #-}
                                                                              )) of
                                                                       { !_hdOoptions ->
                                                                       (case (({-# LINE 215 "src-ag/Desugar.ag" #-}
                                                                               _lhsIforcedIrrefutables
                                                                               {-# LINE 2918 "dist/build/Desugar" #-}
                                                                               )) of
                                                                        { !_hdOforcedIrrefutables ->
                                                                        (case (({-# LINE 185 "src-ag/Desugar.ag" #-}
                                                                                _lhsIdefs
                                                                                {-# LINE 2923 "dist/build/Desugar" #-}
                                                                                )) of
                                                                         { !_hdOdefs ->
                                                                         (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                                 _lhsIchildSyns
                                                                                 {-# LINE 2928 "dist/build/Desugar" #-}
                                                                                 )) of
                                                                          { !_hdOchildSyns ->
                                                                          (case (({-# LINE 126 "src-ag/Desugar.ag" #-}
                                                                                  _lhsIchildInhs
                                                                                  {-# LINE 2933 "dist/build/Desugar" #-}
                                                                                  )) of
                                                                           { !_hdOchildInhs ->
                                                                           (case (hd_1 _hdOchildInhs _hdOchildSyns _hdOcon _hdOdefs _hdOforcedIrrefutables _hdOnt _hdOoptions) of
                                                                            { ( !_hdIallAttributes,!_hdIerrors,!_hdIoutput) ->
                                                                                (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                                                 ...
                                                                                 (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                                                         _hdIerrors Seq.>< _tlIerrors
                                                                                         {-# LINE 2945 "dist/build/Desugar" #-}
                                                                                         )) of
                                                                                  { !_lhsOerrors ->
                                                                                  (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                          (:) _hdIoutput _tlIoutput
                                                                                          {-# LINE 2950 "dist/build/Desugar" #-}
                                                                                          )) of
                                                                                   { !_output ->
                                                                                   (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                                                           _output
                                                                                           {-# LINE 2955 "dist/build/Desugar" #-}
                                                                                           )) of
                                                                                    { !_lhsOoutput ->
                                                                                    ( _lhsOallAttributes,_lhsOerrors,_lhsOoutput) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) }) })))
                          ...
                          sem_Rules_Nil_1 =
                              (T_Rules_1 (\ (!_lhsIchildInhs)
                                            ...
                                            (!_lhsIoptions) ->
                                              (case (({-# LINE 196 "src-ag/Desugar.ag" #-}
                                                      Map.empty
                                                      {-# LINE 2980 "dist/build/Desugar" #-}
                                                      )) of
                                               { !_lhsOallAttributes ->
                                               (case (({-# LINE 38 "src-ag/Desugar.ag" #-}
                                                       Seq.empty
                                                       {-# LINE 2985 "dist/build/Desugar" #-}
                                                       )) of
                                                { !_lhsOerrors ->
                                                (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                        []
                                                        {-# LINE 2990 "dist/build/Desugar" #-}
                                                        )) of
                                                 { !_output ->
                                                 (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                                         _output
                                                         {-# LINE 2995 "dist/build/Desugar" #-}
                                                         )) of
                                                  { !_lhsOoutput ->
                                                  ( _lhsOallAttributes,_lhsOerrors,_lhsOoutput) }) }) }) })))
...
sem_TypeSig_TypeSig !name_ !tp_ =
    (T_TypeSig (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                       TypeSig name_ tp_
                       {-# LINE 3035 "dist/build/Desugar" #-}
                       )) of
                { !_output ->
                (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                        _output
                        {-# LINE 3040 "dist/build/Desugar" #-}
                        )) of
                 { !_lhsOoutput ->
                 ( _lhsOoutput) }) }))
-- TypeSigs ----------------------------------------------------
                 ...
                 { ( !_tlIoutput) ->
                     (case (hd_) of
                      { ( !_hdIoutput) ->
                          (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                  (:) _hdIoutput _tlIoutput
                                  {-# LINE 3084 "dist/build/Desugar" #-}
                                  )) of
                           { !_output ->
                           (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                                   _output
                                   {-# LINE 3089 "dist/build/Desugar" #-}
                                   )) of
                            { !_lhsOoutput ->
                            ( _lhsOoutput) }) }) }) }))
...
sem_TypeSigs_Nil =
    (T_TypeSigs (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                        []
                        {-# LINE 3097 "dist/build/Desugar" #-}
                        )) of
                 { !_output ->
                 (case (({-# LINE 40 "src-ag/Desugar.ag" #-}
                         _output
                         {-# LINE 3102 "dist/build/Desugar" #-}
                         )) of
                  { !_lhsOoutput ->
                  ( _lhsOoutput) }) }))