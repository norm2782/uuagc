...
-- UUAGC 0.9.42.2 (src-ag/TfmToVisage.ag)
...
-}
{-# LINE 94 "dist/build/TfmToVisage.hs" #-}
-- Child -------------------------------------------------------
{-
   visit 0:
                  ...
                  (let _lhsOvchild :: VisageChild
                       ...
                       _lhsOvchild =
                           ({-# LINE 121 "./src-ag/TfmToVisage.ag" #-}
                            ...
                            {-# LINE 145 "dist/build/TfmToVisage.hs" #-}
                            )
                     ...
                     (let _lhsOvchildren :: ([VisageChild])
                          ...
                          _lhsOvchildren =
                              ({-# LINE 117 "./src-ag/TfmToVisage.ag" #-}
                               ...
                               {-# LINE 222 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOinhMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIinhMap
                               {-# LINE 228 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOrulemap =
                              ({-# LINE 83 "./src-ag/TfmToVisage.ag" #-}
                               _lhsIrulemap
                               {-# LINE 234 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOsynMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 240 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOinhMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIinhMap
                               {-# LINE 246 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOrulemap =
                              ({-# LINE 84 "./src-ag/TfmToVisage.ag" #-}
                               _lhsIrulemap
                               {-# LINE 252 "dist/build/TfmToVisage.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOsynMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 258 "dist/build/TfmToVisage.hs" #-}
                               )
                          ( _hdIvchild) =
                     ...
                     (let _lhsOvchildren :: ([VisageChild])
                          ...
                          _lhsOvchildren =
                              ({-# LINE 118 "./src-ag/TfmToVisage.ag" #-}
                               []
                               {-# LINE 275 "dist/build/TfmToVisage.hs" #-}
                               )
                      in  ( _lhsOvchildren))))
-- Expression --------------------------------------------------
{-
    ...
    (T_Expression (let _lhsOself :: Expression
                       ...
                       _self =
                           ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                            ...
                            {-# LINE 314 "dist/build/TfmToVisage.hs" #-}
                            )
                       -- self rule
                       _lhsOself =
                           ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                            _self
                            {-# LINE 320 "dist/build/TfmToVisage.hs" #-}
                            )
                   in  ( _lhsOself)))
-- Grammar -----------------------------------------------------
{-
    ...
    (T_Grammar (let _lhsOvisage :: VisageGrammar
                    ...
                    _lhsOvisage =
                        ({-# LINE 90 "./src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 386 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- "./src-ag/DistChildAttr.ag"(line 15, column 13)
                    _nontsOinhMap =
                        ({-# LINE 15 "./src-ag/DistChildAttr.ag" #-}
                         _nontsIinhMap'
                         {-# LINE 392 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- "./src-ag/DistChildAttr.ag"(line 16, column 13)
                    _nontsOsynMap =
                        ({-# LINE 16 "./src-ag/DistChildAttr.ag" #-}
                         _nontsIsynMap'
                         {-# LINE 398 "dist/build/TfmToVisage.hs" #-}
                         )
                        ...
                        (let _lhsOvnont :: VisageNonterminal
                             ...
                             _lhsOvnont =
                                 ({-# LINE 100 "./src-ag/TfmToVisage.ag" #-}
                                  ...
                                  {-# LINE 457 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- "./src-ag/DistChildAttr.ag"(line 7, column 18)
                             _lhsOinhMap' =
                                 ({-# LINE 7 "./src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ inh_
                                  {-# LINE 463 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- "./src-ag/DistChildAttr.ag"(line 8, column 18)
                             _lhsOsynMap' =
                                 ({-# LINE 8 "./src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ syn_
                                  {-# LINE 469 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 475 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 481 "dist/build/TfmToVisage.hs" #-}
                                  )
                             ( _prodsIvprods) =
                       ...
                       _lhsIsynMap ->
                         (let _lhsOvnonts :: ([VisageNonterminal])
                              ...
                              _hdOinhMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 560 "dist/build/TfmToVisage.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOsynMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 566 "dist/build/TfmToVisage.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOinhMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 572 "dist/build/TfmToVisage.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOsynMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 578 "dist/build/TfmToVisage.hs" #-}
                                   )
                         ...
                         (let _lhsOvnonts :: ([VisageNonterminal])
                              ...
                              _lhsOvnonts =
                                  ({-# LINE 96 "./src-ag/TfmToVisage.ag" #-}
                                   []
                                   {-# LINE 596 "dist/build/TfmToVisage.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOinhMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 602 "dist/build/TfmToVisage.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOsynMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 608 "dist/build/TfmToVisage.hs" #-}
                                   )
                          in  ( _lhsOinhMap',_lhsOsynMap',_lhsOvnonts))))
-- Pattern -----------------------------------------------------
{-
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 136 "./src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 689 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- use rule "./src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                         _patsIfieldattrs
                         {-# LINE 695 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         Constr name_ _patsIcopy
                         {-# LINE 701 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         Constr name_ _patsIself
                         {-# LINE 707 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 713 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 719 "dist/build/TfmToVisage.hs" #-}
                         )
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 137 "./src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 740 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- use rule "./src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                         _patsIfieldattrs
                         {-# LINE 746 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         Product pos_ _patsIcopy
                         {-# LINE 752 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         Product pos_ _patsIself
                         {-# LINE 758 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 764 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 770 "dist/build/TfmToVisage.hs" #-}
                         )
                    ( _patsIcopy,_patsIfieldattrs,_patsIself,_patsIvpats) =
                        pats_
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 138 "./src-ag/TfmToVisage.ag" #-}
                         ...
                         {-# LINE 794 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- "./src-ag/TfmToVisage.ag"(line 147, column 17)
                    _lhsOfieldattrs =
                        ({-# LINE 147 "./src-ag/TfmToVisage.ag" #-}
                         [(field_, attr_)]
                         {-# LINE 800 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         Alias field_ attr_ _patIcopy
                         {-# LINE 806 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         Alias field_ attr_ _patIself
                         {-# LINE 812 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 818 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 824 "dist/build/TfmToVisage.hs" #-}
                         )
...
sem_Pattern_Irrefutable (T_Pattern pat_) =
    (T_Pattern (let _lhsOfieldattrs :: ( [(Identifier,Identifier)] )
                    ...
                    _lhsOfieldattrs =
                        ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                         _patIfieldattrs
                         {-# LINE 844 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         Irrefutable _patIcopy
                         {-# LINE 850 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         Irrefutable _patIself
                         {-# LINE 856 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 862 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 868 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- copy rule (up)
                    _lhsOvpat =
                        ({-# LINE 85 "./src-ag/TfmToVisage.ag" #-}
                         _patIvpat
                         {-# LINE 874 "dist/build/TfmToVisage.hs" #-}
                         )
                    ( _patIcopy,_patIfieldattrs,_patIself,_patIvpat) =
                        pat_
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
    ...
    (T_Pattern (let _lhsOvpat :: VisagePattern
                    ...
                    _lhsOvpat =
                        ({-# LINE 141 "./src-ag/TfmToVisage.ag" #-}
                         VUnderscore pos_
                         {-# LINE 890 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- use rule "./src-ag/TfmToVisage.ag"(line 144, column 43)
                    _lhsOfieldattrs =
                        ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                         []
                         {-# LINE 896 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _copy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         Underscore pos_
                         {-# LINE 902 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _self =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         Underscore pos_
                         {-# LINE 908 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOcopy =
                        ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                         _copy
                         {-# LINE 914 "dist/build/TfmToVisage.hs" #-}
                         )
                    -- self rule
                    _lhsOself =
                        ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                         _self
                         {-# LINE 920 "dist/build/TfmToVisage.hs" #-}
                         )
                in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpat)))
-- Patterns ----------------------------------------------------
{-
    ...
    (T_Patterns (let _lhsOvpats :: ([VisagePattern])
                     ...
                     _lhsOvpats =
                         ({-# LINE 132 "./src-ag/TfmToVisage.ag" #-}
                          _hdIvpat : _tlIvpats
                          {-# LINE 978 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- use rule "./src-ag/TfmToVisage.ag"(line 144, column 43)
                     _lhsOfieldattrs =
                         ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                          _hdIfieldattrs  ++  _tlIfieldattrs
                          {-# LINE 984 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                          (:) _hdIcopy _tlIcopy
                          {-# LINE 990 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _self =
                         ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                          (:) _hdIself _tlIself
                          {-# LINE 996 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 1002 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _lhsOself =
                         ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                          _self
                          {-# LINE 1008 "dist/build/TfmToVisage.hs" #-}
                          )
    ...
    (T_Patterns (let _lhsOvpats :: ([VisagePattern])
                     ...
                     _lhsOvpats =
                         ({-# LINE 133 "./src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1025 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- use rule "./src-ag/TfmToVisage.ag"(line 144, column 43)
                     _lhsOfieldattrs =
                         ({-# LINE 144 "./src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1031 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _copy =
                         ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                          []
                          {-# LINE 1037 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _self =
                         ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                          []
                          {-# LINE 1043 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _lhsOcopy =
                         ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                          _copy
                          {-# LINE 1049 "dist/build/TfmToVisage.hs" #-}
                          )
                     -- self rule
                     _lhsOself =
                         ({-# LINE 74 "./src-ag/TfmToVisage.ag" #-}
                          _self
                          {-# LINE 1055 "dist/build/TfmToVisage.hs" #-}
                          )
                 in  ( _lhsOcopy,_lhsOfieldattrs,_lhsOself,_lhsOvpats)))
-- Production --------------------------------------------------
{-
                        ...
                        (let _lhsOvprods :: ([VisageProduction])
                             ...
                             _lhsOvprods =
                                 ({-# LINE 104 "./src-ag/TfmToVisage.ag" #-}
                                  ...
                                  {-# LINE 1209 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 1215 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 1221 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 1227 "dist/build/TfmToVisage.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 1233 "dist/build/TfmToVisage.hs" #-}
                                  )
                             ( _hdIvprod) =
                                 hd_ _hdOinhMap _hdOsynMap
                             ( _tlIvprods) =
                        ...
                        (let _lhsOvprods :: ([VisageProduction])
                             ...
                             _lhsOvprods =
                                 ({-# LINE 106 "./src-ag/TfmToVisage.ag" #-}
                                  []
                                  {-# LINE 1249 "dist/build/TfmToVisage.hs" #-}
                                  )
                         in  ( _lhsOvprods))))
-- Rule --------------------------------------------------------
{-
    ...
    (T_Rule (let _lhsOvrule :: VisageRule
                 ...
                 _lhsOvrule =
                     ({-# LINE 129 "./src-ag/TfmToVisage.ag" #-}
                      ...
                      {-# LINE 1307 "dist/build/TfmToVisage.hs" #-}
                      )
    ...
    (T_Rules (let _lhsOvrules :: ([VisageRule])
                  ...
                  _lhsOvrules =
                      ({-# LINE 124 "./src-ag/TfmToVisage.ag" #-}
                       ...
                       {-# LINE 1351 "dist/build/TfmToVisage.hs" #-}
                       )
                  ( _hdIvrule) =
                      hd_
                  ( _tlIvrules) =
    ...
    (T_Rules (let _lhsOvrules :: ([VisageRule])
                  ...
                  _lhsOvrules =
                      ({-# LINE 125 "./src-ag/TfmToVisage.ag" #-}
                       []
                       {-# LINE 1365 "dist/build/TfmToVisage.hs" #-}
                       )
              in  ( _lhsOvrules)))
-- TypeSig -----------------------------------------------------
{-
