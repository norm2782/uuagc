...
-- UUAGC 0.9.42.0 (src-ag/ResolveLocals.ag)
                  ...
                  (let _lhsOattributes :: ([(Identifier,Attributes,Attributes)])
                       ...
                       _lhsOattributes =
                           ({-# LINE 84 "./src-ag/ResolveLocals.ag" #-}
                            [(name_, _inh    , _syn    )]
                            {-# LINE 125 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- "./src-ag/ResolveLocals.ag"(line 87, column 11)
                       _lhsOfield =
                           ({-# LINE 87 "./src-ag/ResolveLocals.ag" #-}
                            (name_, tp_, kind_)
                            {-# LINE 131 "dist/build/ResolveLocals.hs" #-}
                            )
                     ...
                     (let _lhsOfields :: ([(Identifier,Type,ChildKind)])
                          ...
                          _lhsOfields =
                              ({-# LINE 90 "./src-ag/ResolveLocals.ag" #-}
                               ...
                               {-# LINE 267 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 82, column 32)
                          _lhsOattributes =
                              ({-# LINE 82 "./src-ag/ResolveLocals.ag" #-}
                               _hdIattributes ++ _tlIattributes
                               {-# LINE 273 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _output =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               (:) _hdIoutput _tlIoutput
                               {-# LINE 279 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOoutput =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               _output
                               {-# LINE 285 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOallfields =
                              ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIallfields
                               {-# LINE 291 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOallnts =
                              ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIallnts
                               {-# LINE 297 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOattrs =
                              ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIattrs
                               {-# LINE 303 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOcon =
                              ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIcon
                               {-# LINE 309 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOinh =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIinh
                               {-# LINE 315 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOinhMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIinhMap
                               {-# LINE 321 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOmergeMap =
                              ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                               _lhsImergeMap
                               {-# LINE 327 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOnt =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsInt
                               {-# LINE 333 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOsyn =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIsyn
                               {-# LINE 339 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOsynMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 345 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOallfields =
                              ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIallfields
                               {-# LINE 351 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOallnts =
                              ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIallnts
                               {-# LINE 357 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOattrs =
                              ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIattrs
                               {-# LINE 363 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOcon =
                              ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIcon
                               {-# LINE 369 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOinh =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIinh
                               {-# LINE 375 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOinhMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                          ...
                          _tlOnt =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsInt
                               {-# LINE 393 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOsyn =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIsyn
                               {-# LINE 399 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOsynMap =
                              ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                               _lhsIsynMap
                               {-# LINE 405 "dist/build/ResolveLocals.hs" #-}
                               )
                     ...
                     (let _lhsOfields :: ([(Identifier,Type,ChildKind)])
                          ...
                          _lhsOfields =
                              ({-# LINE 91 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 431 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 82, column 32)
                          _lhsOattributes =
                              ({-# LINE 82 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 437 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _output =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 443 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOoutput =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               _output
                               {-# LINE 449 "dist/build/ResolveLocals.hs" #-}
                               )
                      in  ( _lhsOattributes,_lhsOfields,_lhsOoutput))))
-- Expression --------------------------------------------------
{-
                    ...
                    (let _nontsOallnts :: ([Identifier])
                         ...
                         _nontsOallnts =
                             ({-# LINE 60 "./src-ag/ResolveLocals.ag" #-}
                              ...
                              {-# LINE 621 "dist/build/ResolveLocals.hs" #-}
                              )
                         ...
                         _nontsOmergeMap =
                             ({-# LINE 120 "./src-ag/ResolveLocals.ag" #-}
                              ...
                              {-# LINE 627 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- "./src-ag/DistChildAttr.ag"(line 15, column 13)
                         _nontsOinhMap =
                             ({-# LINE 15 "./src-ag/DistChildAttr.ag" #-}
                              _nontsIinhMap'
                              {-# LINE 633 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- "./src-ag/DistChildAttr.ag"(line 16, column 13)
                         _nontsOsynMap =
                             ({-# LINE 16 "./src-ag/DistChildAttr.ag" #-}
                              _nontsIsynMap'
                              {-# LINE 639 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              _nontsIerrors
                              {-# LINE 645 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              ...
                              {-# LINE 651 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 657 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _nontsOoptions =
                             ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIoptions
                              {-# LINE 663 "dist/build/ResolveLocals.hs" #-}
                              )
                        ...
                        (let _lhsOnonts :: ([(NontermIdent,[ConstructorIdent])])
                             ...
                             _mergeMap =
                                 ({-# LINE 128 "./src-ag/ResolveLocals.ag" #-}
                                  ...
                                  {-# LINE 770 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- "./src-ag/DistChildAttr.ag"(line 7, column 18)
                             _lhsOinhMap' =
                                 ({-# LINE 7 "./src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ inh_
                                  {-# LINE 776 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- "./src-ag/DistChildAttr.ag"(line 8, column 18)
                             _lhsOsynMap' =
                                 ({-# LINE 8 "./src-ag/DistChildAttr.ag" #-}
                                  Map.singleton nt_ syn_
                                  {-# LINE 782 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                             _lhsOerrors =
                                 ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                  _prodsIerrors
                                  {-# LINE 788 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _output =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  Nonterminal nt_ params_ inh_ syn_ _prodsIoutput
                                  {-# LINE 794 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _lhsOoutput =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  _output
                                  {-# LINE 800 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOallnts =
                                 ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIallnts
                                  {-# LINE 806 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 812 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (from local)
                             _prodsOmergeMap =
                                 ({-# LINE 126 "./src-ag/ResolveLocals.ag" #-}
                                  _mergeMap
                                  {-# LINE 818 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOoptions =
                                 ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIoptions
                                  {-# LINE 824 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _prodsOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 830 "dist/build/ResolveLocals.hs" #-}
                                  )
                         ...
                         (let _lhsOerrors :: (Seq Error)
                              ...
                              _lhsOerrors =
                                  ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                   ...
                                   {-# LINE 918 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOinhMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   _hdIinhMap' `Map.union` _tlIinhMap'
                                   {-# LINE 924 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/ResolveLocals.ag"(line 62, column 43)
                              _lhsOnonts =
                                  ({-# LINE 62 "./src-ag/ResolveLocals.ag" #-}
                                   _hdInonts ++ _tlInonts
                                   {-# LINE 930 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOsynMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   _hdIsynMap' `Map.union` _tlIsynMap'
                                   {-# LINE 936 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- self rule
                              _output =
                                  ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                   (:) _hdIoutput _tlIoutput
                                   {-# LINE 942 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- self rule
                              _lhsOoutput =
                                  ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                   _output
                                   {-# LINE 948 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOallnts =
                                  ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsIallnts
                                   {-# LINE 954 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOinhMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 960 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOmergeMap =
                                  ({-# LINE 123 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsImergeMap
                                   {-# LINE 966 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOoptions =
                                  ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsIoptions
                                   {-# LINE 972 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _hdOsynMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 978 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOallnts =
                                  ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsIallnts
                                   {-# LINE 984 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOinhMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIinhMap
                                   {-# LINE 990 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOmergeMap =
                                  ({-# LINE 123 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsImergeMap
                                   {-# LINE 996 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOoptions =
                                  ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                   _lhsIoptions
                                   {-# LINE 1002 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- copy rule (down)
                              _tlOsynMap =
                                  ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                   _lhsIsynMap
                                   {-# LINE 1008 "dist/build/ResolveLocals.hs" #-}
                                   )
                       ...
                       _lhsIsynMap ->
                         (let _lhsOerrors :: (Seq Error)
                              ...
                              _lhsOerrors =
                                  ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                   Seq.empty
                                   {-# LINE 1031 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOinhMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 1037 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/ResolveLocals.ag"(line 62, column 43)
                              _lhsOnonts =
                                  ({-# LINE 62 "./src-ag/ResolveLocals.ag" #-}
                                   []
                                   {-# LINE 1043 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- use rule "./src-ag/DistChildAttr.ag"(line 4, column 53)
                              _lhsOsynMap' =
                                  ({-# LINE 4 "./src-ag/DistChildAttr.ag" #-}
                                   Map.empty
                                   {-# LINE 1049 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- self rule
                              _output =
                                  ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                   []
                                   {-# LINE 1055 "dist/build/ResolveLocals.hs" #-}
                                   )
                              -- self rule
                              _lhsOoutput =
                                  ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                   _output
                                   {-# LINE 1061 "dist/build/ResolveLocals.hs" #-}
                                   )
                          in  ( _lhsOerrors,_lhsOinhMap',_lhsOnonts,_lhsOoutput,_lhsOsynMap'))))
-- Pattern -----------------------------------------------------
{-
                  ...
                  _lhsIsyn ->
                    (let _lhsOerrors :: (Seq Error)
                         ...
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              _patsIerrors
                              {-# LINE 1162 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                         _lhsOinstVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patsIinstVars
                              {-# LINE 1168 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                         _lhsOlocVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patsIlocVars
                              {-# LINE 1174 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _copy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              Constr name_ _patsIcopy
                              {-# LINE 1180 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              Constr name_ _patsIoutput
                              {-# LINE 1186 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOcopy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1192 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 1198 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOcon =
                             ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIcon
                              {-# LINE 1204 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOinh =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIinh
                              {-# LINE 1210 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOnt =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsInt
                              {-# LINE 1216 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOsyn =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIsyn
                              {-# LINE 1222 "dist/build/ResolveLocals.hs" #-}
                              )
                  ...
                  _lhsIsyn ->
                    (let _lhsOerrors :: (Seq Error)
                         ...
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              _patsIerrors
                              {-# LINE 1253 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                         _lhsOinstVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patsIinstVars
                              {-# LINE 1259 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                         _lhsOlocVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patsIlocVars
                              {-# LINE 1265 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _copy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              Product pos_ _patsIcopy
                              {-# LINE 1271 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              Product pos_ _patsIoutput
                              {-# LINE 1277 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOcopy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1283 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 1289 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOcon =
                             ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIcon
                              {-# LINE 1295 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOinh =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIinh
                              {-# LINE 1301 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOnt =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsInt
                              {-# LINE 1307 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patsOsyn =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIsyn
                              {-# LINE 1313 "dist/build/ResolveLocals.hs" #-}
                              )
                         ( _patsIcopy,_patsIerrors,_patsIinstVars,_patsIlocVars,_patsIoutput) =
                             pats_ _patsOcon _patsOinh _patsOnt _patsOsyn
                     in  ( _lhsOcopy,_lhsOerrors,_lhsOinstVars,_lhsOlocVars,_lhsOoutput))))
                    ...
                    (let _lhsOlocVars :: ([Identifier])
                         ...
                         _lhsOlocVars =
                             ({-# LINE 96 "./src-ag/ResolveLocals.ag" #-}
                              ...
                              {-# LINE 1347 "dist/build/ResolveLocals.hs" #-}
                              )
                         ...
                         _lhsOinstVars =
                             ({-# LINE 99 "./src-ag/ResolveLocals.ag" #-}
                              ...
                              {-# LINE 1355 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              _patIerrors
                              {-# LINE 1361 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _copy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              Alias field_ attr_ _patIcopy
                              {-# LINE 1367 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              Alias field_ attr_ _patIoutput
                              {-# LINE 1373 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOcopy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1379 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 1385 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOcon =
                             ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIcon
                              {-# LINE 1391 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOinh =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIinh
                              {-# LINE 1397 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOnt =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsInt
                              {-# LINE 1403 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOsyn =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIsyn
                              {-# LINE 1409 "dist/build/ResolveLocals.hs" #-}
                              )
                  ...
                  _lhsIsyn ->
                    (let _lhsOerrors :: (Seq Error)
                         ...
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              _patIerrors
                              {-# LINE 1439 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                         _lhsOinstVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patIinstVars
                              {-# LINE 1445 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                         _lhsOlocVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              _patIlocVars
                              {-# LINE 1451 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _copy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              Irrefutable _patIcopy
                              {-# LINE 1457 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              Irrefutable _patIoutput
                              {-# LINE 1463 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOcopy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1469 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 1475 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOcon =
                             ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIcon
                              {-# LINE 1481 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOinh =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIinh
                              {-# LINE 1487 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOnt =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsInt
                              {-# LINE 1493 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- copy rule (down)
                         _patOsyn =
                             ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                              _lhsIsyn
                              {-# LINE 1499 "dist/build/ResolveLocals.hs" #-}
                              )
                         ( _patIcopy,_patIerrors,_patIinstVars,_patIlocVars,_patIoutput) =
                             pat_ _patOcon _patOinh _patOnt _patOsyn
                     in  ( _lhsOcopy,_lhsOerrors,_lhsOinstVars,_lhsOlocVars,_lhsOoutput))))
                  ...
                  _lhsIsyn ->
                    (let _lhsOerrors :: (Seq Error)
                         ...
                         _lhsOerrors =
                             ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                              Seq.empty
                              {-# LINE 1520 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                         _lhsOinstVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              []
                              {-# LINE 1526 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                         _lhsOlocVars =
                             ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                              []
                              {-# LINE 1532 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _copy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              Underscore pos_
                              {-# LINE 1538 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _output =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              Underscore pos_
                              {-# LINE 1544 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOcopy =
                             ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                              _copy
                              {-# LINE 1550 "dist/build/ResolveLocals.hs" #-}
                              )
                         -- self rule
                         _lhsOoutput =
                             ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                              _output
                              {-# LINE 1556 "dist/build/ResolveLocals.hs" #-}
                              )
                     in  ( _lhsOcopy,_lhsOerrors,_lhsOinstVars,_lhsOlocVars,_lhsOoutput))))
-- Patterns ----------------------------------------------------
{-
                   ...
                   _lhsIsyn ->
                     (let _lhsOerrors :: (Seq Error)
                          ...
                          _lhsOerrors =
                              ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                               _hdIerrors Seq.>< _tlIerrors
                               {-# LINE 1639 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                          _lhsOinstVars =
                              ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                               _hdIinstVars ++ _tlIinstVars
                               {-# LINE 1645 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                          _lhsOlocVars =
                              ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                               _hdIlocVars ++ _tlIlocVars
                               {-# LINE 1651 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _copy =
                              ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                               (:) _hdIcopy _tlIcopy
                               {-# LINE 1657 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _output =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               (:) _hdIoutput _tlIoutput
                               {-# LINE 1663 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOcopy =
                              ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                               _copy
                               {-# LINE 1669 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOoutput =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               _output
                               {-# LINE 1675 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOcon =
                              ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIcon
                               {-# LINE 1681 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOinh =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIinh
                               {-# LINE 1687 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOnt =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsInt
                               {-# LINE 1693 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _hdOsyn =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIsyn
                               {-# LINE 1699 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOcon =
                              ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIcon
                               {-# LINE 1705 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOinh =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIinh
                               {-# LINE 1711 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOnt =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsInt
                               {-# LINE 1717 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- copy rule (down)
                          _tlOsyn =
                              ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                               _lhsIsyn
                               {-# LINE 1723 "dist/build/ResolveLocals.hs" #-}
                               )
                   ...
                   _lhsIsyn ->
                     (let _lhsOerrors :: (Seq Error)
                          ...
                          _lhsOerrors =
                              ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                               Seq.empty
                               {-# LINE 1745 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                          _lhsOinstVars =
                              ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 1751 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                          _lhsOlocVars =
                              ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 1757 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _copy =
                              ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                               []
                               {-# LINE 1763 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _output =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               []
                               {-# LINE 1769 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOcopy =
                              ({-# LINE 22 "./src-ag/Patterns.ag" #-}
                               _copy
                               {-# LINE 1775 "dist/build/ResolveLocals.hs" #-}
                               )
                          -- self rule
                          _lhsOoutput =
                              ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                               _output
                               {-# LINE 1781 "dist/build/ResolveLocals.hs" #-}
                               )
                      in  ( _lhsOcopy,_lhsOerrors,_lhsOinstVars,_lhsOlocVars,_lhsOoutput))))
-- Production --------------------------------------------------
{-
                       ...
                       (let _lhsOcons :: ([ConstructorIdent])
                            ...
                            _lhsOcons =
                                ({-# LINE 67 "./src-ag/ResolveLocals.ag" #-}
                                 [con_]
                                 {-# LINE 1891 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- "./src-ag/ResolveLocals.ag"(line 74, column 16)
                            _allfields =
                                ({-# LINE 74 "./src-ag/ResolveLocals.ag" #-}
                                 _childrenIfields
                                 {-# LINE 1897 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- "./src-ag/ResolveLocals.ag"(line 74, column 16)
                            _attrs =
                            ...
                            _mergeMap =
                                ({-# LINE 129 "./src-ag/ResolveLocals.ag" #-}
                                 ...
                                 {-# LINE 1936 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                            _lhsOerrors =
                                ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                 _rulesIerrors
                                 {-# LINE 1942 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- self rule
                            _output =
                                ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                 Production con_ params_ constraints_ _childrenIoutput _rulesIoutput _typeSigsIoutput macro_
                                 {-# LINE 1948 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- self rule
                            _lhsOoutput =
                                ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                 _output
                                 {-# LINE 1954 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _childrenOallfields =
                                ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                                 _allfields
                                 {-# LINE 1960 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOallnts =
                                ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIallnts
                                 {-# LINE 1966 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _childrenOattrs =
                                ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                                 _attrs
                                 {-# LINE 1972 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOinh =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIinh
                                 {-# LINE 1978 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOinhMap =
                                ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                 _lhsIinhMap
                                 {-# LINE 1984 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _childrenOmergeMap =
                                ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                                 _mergeMap
                                 {-# LINE 1990 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOnt =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsInt
                                 {-# LINE 1996 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOsyn =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIsyn
                                 {-# LINE 2002 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _childrenOsynMap =
                                ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                 _lhsIsynMap
                                 {-# LINE 2008 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _rulesOallfields =
                                ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                                 _allfields
                                 {-# LINE 2014 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _rulesOallnts =
                                ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIallnts
                                 {-# LINE 2020 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _rulesOattrs =
                                ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                                 _attrs
                                 {-# LINE 2026 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _rulesOinh =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIinh
                                 {-# LINE 2032 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (from local)
                            _rulesOmergeMap =
                                ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                                 _mergeMap
                                 {-# LINE 2038 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _rulesOnt =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsInt
                                 {-# LINE 2044 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _rulesOoptions =
                                ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIoptions
                                 {-# LINE 2050 "dist/build/ResolveLocals.hs" #-}
                                 )
                            -- copy rule (down)
                            _rulesOsyn =
                                ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                 _lhsIsyn
                                 {-# LINE 2056 "dist/build/ResolveLocals.hs" #-}
                                 )
                        ...
                        (let _lhsOcons :: ([ConstructorIdent])
                             ...
                             _lhsOcons =
                                 ({-# LINE 65 "./src-ag/ResolveLocals.ag" #-}
                                  _hdIcons ++ _tlIcons
                                  {-# LINE 2155 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                             _lhsOerrors =
                                 ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                  _hdIerrors Seq.>< _tlIerrors
                                  {-# LINE 2161 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _output =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  (:) _hdIoutput _tlIoutput
                                  {-# LINE 2167 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _lhsOoutput =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  _output
                                  {-# LINE 2173 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOallnts =
                                 ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIallnts
                                  {-# LINE 2179 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOinh =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIinh
                                  {-# LINE 2185 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 2191 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOmergeMap =
                                 ({-# LINE 126 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsImergeMap
                                  {-# LINE 2197 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOnt =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsInt
                                  {-# LINE 2203 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOoptions =
                                 ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIoptions
                                  {-# LINE 2209 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOsyn =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIsyn
                                  {-# LINE 2215 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _hdOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 2221 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOallnts =
                                 ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIallnts
                                  {-# LINE 2227 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOinh =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIinh
                                  {-# LINE 2233 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOinhMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIinhMap
                                  {-# LINE 2239 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOmergeMap =
                                 ({-# LINE 126 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsImergeMap
                                  {-# LINE 2245 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOnt =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsInt
                                  {-# LINE 2251 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOoptions =
                                 ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIoptions
                                  {-# LINE 2257 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOsyn =
                                 ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                                  _lhsIsyn
                                  {-# LINE 2263 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- copy rule (down)
                             _tlOsynMap =
                                 ({-# LINE 12 "./src-ag/DistChildAttr.ag" #-}
                                  _lhsIsynMap
                                  {-# LINE 2269 "dist/build/ResolveLocals.hs" #-}
                                  )
                      ...
                      _lhsIsynMap ->
                        (let _lhsOcons :: ([ConstructorIdent])
                             ...
                             _lhsOcons =
                                 ({-# LINE 65 "./src-ag/ResolveLocals.ag" #-}
                                  []
                                  {-# LINE 2293 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- use rule "./src-ag/ResolveLocals.ag"(line 44, column 16)
                             _lhsOerrors =
                                 ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                                  Seq.empty
                                  {-# LINE 2299 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _output =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  []
                                  {-# LINE 2305 "dist/build/ResolveLocals.hs" #-}
                                  )
                             -- self rule
                             _lhsOoutput =
                                 ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                                  _output
                                  {-# LINE 2311 "dist/build/ResolveLocals.hs" #-}
                                  )
                         in  ( _lhsOcons,_lhsOerrors,_lhsOoutput))))
-- Rule --------------------------------------------------------
{-
                 ...
                 (let _lhsOerrors :: (Seq Error)
                      ...
                      _lhsOerrors =
                          ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                           ...
                           {-# LINE 2418 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                      _lhsOinstVars =
                          ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                           _patternIinstVars
                           {-# LINE 2424 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                      _lhsOlocVars =
                          ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                           _patternIlocVars
                           {-# LINE 2430 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- self rule
                      _output =
                          ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                           Rule mbName_ _patternIoutput _rhsIoutput owrt_ origin_ explicit_ pure_ identity_ mbError_ eager_
                           {-# LINE 2436 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- self rule
                      _lhsOoutput =
                          ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                           _output
                           {-# LINE 2442 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _patternOcon =
                          ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIcon
                           {-# LINE 2448 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _patternOinh =
                          ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIinh
                           {-# LINE 2454 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _patternOnt =
                          ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                           _lhsInt
                           {-# LINE 2460 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _patternOsyn =
                          ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIsyn
                           {-# LINE 2466 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOallfields =
                          ({-# LINE 139 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIallfields
                           {-# LINE 2472 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOallnts =
                          ({-# LINE 140 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIallnts
                           {-# LINE 2478 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOattrs =
                          ({-# LINE 141 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIattrs
                           {-# LINE 2484 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOcon =
                          ({-# LINE 138 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIcon
                           {-# LINE 2490 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOmergeMap =
                          ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                           _lhsImergeMap
                           {-# LINE 2496 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOnt =
                          ({-# LINE 138 "./src-ag/ResolveLocals.ag" #-}
                           _lhsInt
                           {-# LINE 2502 "dist/build/ResolveLocals.hs" #-}
                           )
                      -- copy rule (down)
                      _rhsOoptions =
                          ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                           _lhsIoptions
                           {-# LINE 2508 "dist/build/ResolveLocals.hs" #-}
                           )
                ...
                _lhsIsyn ->
                  (let _lhsOerrors :: (Seq Error)
                       ...
                       _lhsOerrors =
                           ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                            _hdIerrors Seq.>< _tlIerrors
                            {-# LINE 2614 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                       _lhsOinstVars =
                           ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                            _hdIinstVars ++ _tlIinstVars
                            {-# LINE 2620 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                       _lhsOlocVars =
                           ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                            _hdIlocVars ++ _tlIlocVars
                            {-# LINE 2626 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- self rule
                       _output =
                           ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                            (:) _hdIoutput _tlIoutput
                            {-# LINE 2632 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- self rule
                       _lhsOoutput =
                           ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                            _output
                            {-# LINE 2638 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOallfields =
                           ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIallfields
                            {-# LINE 2644 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOallnts =
                           ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIallnts
                            {-# LINE 2650 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOattrs =
                           ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIattrs
                            {-# LINE 2656 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOcon =
                           ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIcon
                            {-# LINE 2662 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOinh =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIinh
                            {-# LINE 2668 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOmergeMap =
                           ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                            _lhsImergeMap
                            {-# LINE 2674 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOnt =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsInt
                            {-# LINE 2680 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOoptions =
                           ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIoptions
                            {-# LINE 2686 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _hdOsyn =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIsyn
                            {-# LINE 2692 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOallfields =
                           ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIallfields
                            {-# LINE 2698 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOallnts =
                           ({-# LINE 57 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIallnts
                            {-# LINE 2704 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOattrs =
                           ({-# LINE 71 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIattrs
                            {-# LINE 2710 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOcon =
                           ({-# LINE 105 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIcon
                            {-# LINE 2716 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOinh =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIinh
                            {-# LINE 2722 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOmergeMap =
                           ({-# LINE 131 "./src-ag/ResolveLocals.ag" #-}
                            _lhsImergeMap
                            {-# LINE 2728 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOnt =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsInt
                            {-# LINE 2734 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOoptions =
                           ({-# LINE 41 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIoptions
                            {-# LINE 2740 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- copy rule (down)
                       _tlOsyn =
                           ({-# LINE 104 "./src-ag/ResolveLocals.ag" #-}
                            _lhsIsyn
                            {-# LINE 2746 "dist/build/ResolveLocals.hs" #-}
                            )
                ...
                _lhsIsyn ->
                  (let _lhsOerrors :: (Seq Error)
                       ...
                       _lhsOerrors =
                           ({-# LINE 44 "./src-ag/ResolveLocals.ag" #-}
                            Seq.empty
                            {-# LINE 2772 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 86)
                       _lhsOinstVars =
                           ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                            []
                            {-# LINE 2778 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- use rule "./src-ag/ResolveLocals.ag"(line 93, column 48)
                       _lhsOlocVars =
                           ({-# LINE 93 "./src-ag/ResolveLocals.ag" #-}
                            []
                            {-# LINE 2784 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- self rule
                       _output =
                           ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                            []
                            {-# LINE 2790 "dist/build/ResolveLocals.hs" #-}
                            )
                       -- self rule
                       _lhsOoutput =
                           ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                            _output
                            {-# LINE 2796 "dist/build/ResolveLocals.hs" #-}
                            )
                   in  ( _lhsOerrors,_lhsOinstVars,_lhsOlocVars,_lhsOoutput))))
-- TypeSig -----------------------------------------------------
{-
...
sem_TypeSig_TypeSig name_ tp_ =
    (T_TypeSig (let _lhsOoutput :: TypeSig
                    ...
                    _output =
                        ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                         TypeSig name_ tp_
                         {-# LINE 2835 "dist/build/ResolveLocals.hs" #-}
                         )
                    -- self rule
                    _lhsOoutput =
                        ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                         _output
                         {-# LINE 2841 "dist/build/ResolveLocals.hs" #-}
                         )
                in  ( _lhsOoutput)))
-- TypeSigs ----------------------------------------------------
{-
...
sem_TypeSigs_Cons (T_TypeSig hd_) (T_TypeSigs tl_) =
    (T_TypeSigs (let _lhsOoutput :: TypeSigs
                     ...
                     _output =
                         ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                          (:) _hdIoutput _tlIoutput
                          {-# LINE 2885 "dist/build/ResolveLocals.hs" #-}
                          )
                     -- self rule
                     _lhsOoutput =
                         ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                          _output
                          {-# LINE 2891 "dist/build/ResolveLocals.hs" #-}
                          )
                     ( _hdIoutput) =
                         hd_
                     ( _tlIoutput) =
...
sem_TypeSigs_Nil =
    (T_TypeSigs (let _lhsOoutput :: TypeSigs
                     ...
                     _output =
                         ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                          []
                          {-# LINE 2905 "dist/build/ResolveLocals.hs" #-}
                          )
                     -- self rule
                     _lhsOoutput =
                         ({-# LINE 47 "./src-ag/ResolveLocals.ag" #-}
                          _output
                          {-# LINE 2911 "dist/build/ResolveLocals.hs" #-}
                          )
                 in  ( _lhsOoutput)))