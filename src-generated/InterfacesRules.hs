...
-- UUAGC 0.9.42.1 (src-ag/InterfacesRules.lag)
    ...
    (T_IRoot (\ (!_lhsIdpr)
                ...
                (!_lhsItdp) ->
                  (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                          _lhsIinfo
                          {-# LINE 135 "dist/build/InterfacesRules.hs" #-}
                          )) of
                   { !_intersOinfo ->
                   (case (({-# LINE 85 "./src-ag/InterfacesRules.lag" #-}
                           snd (bounds _lhsItdp) + 1
                           {-# LINE 140 "dist/build/InterfacesRules.hs" #-}
                           )) of
                    { !_intersOv ->
                    (case (inters_ _intersOinfo _intersOv) of
                     { ( !_intersIdescr,!_intersIfirstvisitvertices,!_intersInewedges,!_intersIv,!T_Interfaces_1 inters_1) ->
                         (case (({-# LINE 260 "./src-ag/InterfacesRules.lag" #-}
                                 ...
                                 {-# LINE 148 "dist/build/InterfacesRules.hs" #-}
                                 )) of
                          { !_intersOprev ->
                          (case (({-# LINE 71 "./src-ag/InterfacesRules.lag" #-}
                                  toList _intersInewedges
                                  {-# LINE 153 "dist/build/InterfacesRules.hs" #-}
                                  )) of
                           { !_newedges ->
                           (case (({-# LINE 72 "./src-ag/InterfacesRules.lag" #-}
                                   ...
                                   in transposeG graph
                                   {-# LINE 160 "dist/build/InterfacesRules.hs" #-}
                                   )) of
                            { !_visitssGraph ->
                            (case (({-# LINE 218 "./src-ag/InterfacesRules.lag" #-}
                             ...
                             (case (({-# LINE 147 "./src-ag/InterfacesRules.lag" #-}
                                     ...
                                     {-# LINE 170 "dist/build/InterfacesRules.hs" #-}
                                     )) of
                              { !_descr ->
                              (case (({-# LINE 127 "./src-ag/InterfacesRules.lag" #-}
                                      Map.fromList _descr
                                      {-# LINE 175 "dist/build/InterfacesRules.hs" #-}
                                      )) of
                               { !_intersOvisitDescr ->
                                      ...
                                      (case (inters_2 _intersOallInters _intersOddp) of
                                       { ( !_intersIedp,!_intersIvisits) ->
                                           (case (({-# LINE 442 "./src-ag/InterfacesRules.lag" #-}
                                                   toList _intersIedp
                                                   {-# LINE 194 "dist/build/InterfacesRules.hs" #-}
                                                   )) of
                                            { !_lhsOedp ->
                                            (case (({-# LINE 382 "./src-ag/InterfacesRules.lag" #-}
                                                    _intersIinters
                                                    {-# LINE 199 "dist/build/InterfacesRules.hs" #-}
                                                    )) of
                                             { !_lhsOinters ->
                                             (case (({-# LINE 383 "./src-ag/InterfacesRules.lag" #-}
                                                     _intersIvisits
                                                     {-# LINE 204 "dist/build/InterfacesRules.hs" #-}
                                                     )) of
                                              { !_lhsOvisits ->
...
sem_Interface_Interface !nt_ !cons_ !(T_Segments seg_) =
    (T_Interface (\ (!_lhsIinfo)
                    (!_lhsIv) ->
                      (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                              _lhsIinfo
                              {-# LINE 281 "dist/build/InterfacesRules.hs" #-}
                              )) of
                       { !_segOinfo ->
                       (case (({-# LINE 205 "./src-ag/InterfacesRules.lag" #-}
                               0
                               {-# LINE 286 "dist/build/InterfacesRules.hs" #-}
                               )) of
                        { !_segOn ->
                        (case (({-# LINE 195 "./src-ag/InterfacesRules.lag" #-}
                                \a -> ruleTable _lhsIinfo ! a
                                {-# LINE 291 "dist/build/InterfacesRules.hs" #-}
                                )) of
                         { !_look ->
                         (case (({-# LINE 187 "./src-ag/InterfacesRules.lag" #-}
                                 _lhsIv
                                 {-# LINE 296 "dist/build/InterfacesRules.hs" #-}
                                 )) of
                          { !_segOv ->
                                                       ...
                                                       (T_Interface_1 (\ (!_lhsIprev)
                                                                         ...
                                                                         (!_lhsIvssGraph) ->
                                                                           (case (({-# LINE 216 "./src-ag/InterfacesRules.lag" #-}
                                                                                   _lhsIvssGraph
                                                                                   {-# LINE 348 "dist/build/InterfacesRules.hs" #-}
                                                                                   )) of
                                                                            { !_segOvssGraph ->
                                                                            (case (({-# LINE 125 "./src-ag/InterfacesRules.lag" #-}
                                                                             ...
                                                                             (case (({-# LINE 263 "./src-ag/InterfacesRules.lag" #-}
                                                                                     _lhsIprev
                                                                                     {-# LINE 358 "dist/build/InterfacesRules.hs" #-}
                                                                                     )) of
                                                                              { !_segOprev ->
                                                                              (case (({-# LINE 237 "./src-ag/InterfacesRules.lag" #-}
                                                                                      cons_
                                                                                      {-# LINE 363 "dist/build/InterfacesRules.hs" #-}
                                                                                      )) of
                                                                               { !_segOcons ->
                                                                               (case (seg_1 _segOcons _segOprev _segOvisitDescr _segOvssGraph) of
                                                                                { ( !_segIsegs,!T_Segments_2 seg_2) ->
                                                                                    (case (({-# LINE 395 "./src-ag/InterfacesRules.lag" #-}
                                                                                            ...
                                                                                            {-# LINE 370 "dist/build/InterfacesRules.hs" #-}
                                                                                            )) of
                                                                                     { !_lhsOinter ->
                                                                                     (case (({-# LINE 391 "./src-ag/InterfacesRules.lag" #-}
                                                                                             nt_
                                                                                             {-# LINE 375 "dist/build/InterfacesRules.hs" #-}
                                                                                             )) of
                                                                                      { !_lhsOnt ->
                                                                                                      ...
                                                                                                      (T_Interface_2 (\ (!_lhsIallInters)
                                                                                                                        (!_lhsIddp) ->
                                                                                                                          (case (({-# LINE 341 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                  _lhsIddp
                                                                                                                                  {-# LINE 384 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                  )) of
                                                                                                                           { !_segOddp ->
                                                                                                                           (case (({-# LINE 378 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                            ...
                                                                                                                            (case (({-# LINE 351 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                    _lhsIprev
                                                                                                                                    {-# LINE 394 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                    )) of
                                                                                                                             { !_segOfromLhs ->
                                                                                                                             (case (({-# LINE 314 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                     True
                                                                                                                                     {-# LINE 399 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                     )) of
                                                                                                                              { !_segOisFirst ->
    ...
    (T_Interfaces (\ (!_lhsIinfo)
                     (!_lhsIv) ->
                       (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                               _lhsIv
                               {-# LINE 486 "dist/build/InterfacesRules.hs" #-}
                               )) of
                        { !_hdOv ->
                        (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                                _lhsIinfo
                                {-# LINE 491 "dist/build/InterfacesRules.hs" #-}
                                )) of
                         { !_hdOinfo ->
                         (case (hd_ _hdOinfo _hdOv) of
                          { ( !_hdIdescr,!_hdIfirstvisitvertices,!_hdInewedges,!_hdIv,!T_Interface_1 hd_1) ->
                              (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                               ...
                               (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                                       _lhsIinfo
                                       {-# LINE 503 "dist/build/InterfacesRules.hs" #-}
                                       )) of
                                { !_tlOinfo ->
                                (case (tl_ _tlOinfo _tlOv) of
                                 { ( !_tlIdescr,!_tlIfirstvisitvertices,!_tlInewedges,!_tlIv,!T_Interfaces_1 tl_1) ->
                                     (case (({-# LINE 130 "./src-ag/InterfacesRules.lag" #-}
                                             ...
                                             {-# LINE 510 "dist/build/InterfacesRules.hs" #-}
                                             )) of
                                      { !_lhsOdescr ->
                                      (case (({-# LINE 258 "./src-ag/InterfacesRules.lag" #-}
                                              _hdIfirstvisitvertices ++ _tlIfirstvisitvertices
                                              {-# LINE 515 "dist/build/InterfacesRules.hs" #-}
                                              )) of
                                       { !_lhsOfirstvisitvertices ->
                                       (case (({-# LINE 129 "./src-ag/InterfacesRules.lag" #-}
                                               _hdInewedges Seq.>< _tlInewedges
                                               {-# LINE 520 "dist/build/InterfacesRules.hs" #-}
                                               )) of
                                        { !_lhsOnewedges ->
                                        (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                                _tlIv
                                                {-# LINE 525 "dist/build/InterfacesRules.hs" #-}
                                                )) of
                                         { !_lhsOv ->
                                                     ...
                                                     sem_Interfaces_Cons_1 =
                                                         (T_Interfaces_1 (\ (!_lhsIprev)
                                                                            ...
                                                                            (!_lhsIvssGraph) ->
                                                                              (case (({-# LINE 216 "./src-ag/InterfacesRules.lag" #-}
                                                                                      _lhsIvssGraph
                                                                                      {-# LINE 535 "dist/build/InterfacesRules.hs" #-}
                                                                                      )) of
                                                                               { !_tlOvssGraph ->
                                                                               (case (({-# LINE 125 "./src-ag/InterfacesRules.lag" #-}
                                                                                       _lhsIvisitDescr
                                                                                       {-# LINE 540 "dist/build/InterfacesRules.hs" #-}
                                                                                       )) of
                                                                                { !_tlOvisitDescr ->
                                                                                (case (({-# LINE 258 "./src-ag/InterfacesRules.lag" #-}
                                                                                        _lhsIprev
                                                                                        {-# LINE 545 "dist/build/InterfacesRules.hs" #-}
                                                                                        )) of
                                                                                 { !_tlOprev ->
                                                                                 (case (({-# LINE 216 "./src-ag/InterfacesRules.lag" #-}
                                                                                         _lhsIvssGraph
                                                                                         {-# LINE 550 "dist/build/InterfacesRules.hs" #-}
                                                                                         )) of
                                                                                  { !_hdOvssGraph ->
                                                                                  (case (({-# LINE 125 "./src-ag/InterfacesRules.lag" #-}
                                                                                          _lhsIvisitDescr
                                                                                          {-# LINE 555 "dist/build/InterfacesRules.hs" #-}
                                                                                          )) of
                                                                                   { !_hdOvisitDescr ->
                                                                                   (case (({-# LINE 258 "./src-ag/InterfacesRules.lag" #-}
                                                                                           _lhsIprev
                                                                                           {-# LINE 560 "dist/build/InterfacesRules.hs" #-}
                                                                                           )) of
                                                                                    { !_hdOprev ->
                                                                                         ...
                                                                                         (case (hd_1 _hdOprev _hdOvisitDescr _hdOvssGraph) of
                                                                                          { ( !_hdIinter,!_hdInt,!T_Interface_2 hd_2) ->
                                                                                              (case (({-# LINE 385 "./src-ag/InterfacesRules.lag" #-}
                                                                                                      ...
                                                                                                      {-# LINE 569 "dist/build/InterfacesRules.hs" #-}
                                                                                                      )) of
                                                                                               { !_lhsOinters ->
                                                                                                           ...
                                                                                                           sem_Interfaces_Cons_2 =
                                                                                                               (T_Interfaces_2 (\ (!_lhsIallInters)
                                                                                                                                  (!_lhsIddp) ->
                                                                                                                                    (case (({-# LINE 341 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                            _lhsIddp
                                                                                                                                            {-# LINE 578 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                            )) of
                                                                                                                                     { !_tlOddp ->
                                                                                                                                     (case (({-# LINE 378 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                             _lhsIallInters
                                                                                                                                             {-# LINE 583 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                             )) of
                                                                                                                                      { !_tlOallInters ->
                                                                                                                                      (case (tl_2 _tlOallInters _tlOddp) of
                                                                                                                                       { ( !_tlIedp,!_tlIvisits) ->
                                                                                                                                           (case (({-# LINE 341 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                   _lhsIddp
                                                                                                                                                   {-# LINE 590 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                   )) of
                                                                                                                                            { !_hdOddp ->
                                                                                                                                            (case (({-# LINE 378 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                    _lhsIallInters
                                                                                                                                                    {-# LINE 595 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                    )) of
                                                                                                                                             { !_hdOallInters ->
...
sem_Interfaces_Nil =
    (T_Interfaces (\ (!_lhsIinfo)
                     (!_lhsIv) ->
                       (case (({-# LINE 130 "./src-ag/InterfacesRules.lag" #-}
                               Seq.empty
                               {-# LINE 623 "dist/build/InterfacesRules.hs" #-}
                               )) of
                        { !_lhsOdescr ->
                        (case (({-# LINE 258 "./src-ag/InterfacesRules.lag" #-}
                                []
                                {-# LINE 628 "dist/build/InterfacesRules.hs" #-}
                                )) of
                         { !_lhsOfirstvisitvertices ->
                         (case (({-# LINE 129 "./src-ag/InterfacesRules.lag" #-}
                                 Seq.empty
                                 {-# LINE 633 "dist/build/InterfacesRules.hs" #-}
                                 )) of
                          { !_lhsOnewedges ->
                          (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                  _lhsIv
                                  {-# LINE 638 "dist/build/InterfacesRules.hs" #-}
                                  )) of
                           { !_lhsOv ->
                                           ...
                                           (T_Interfaces_1 (\ (!_lhsIprev)
                                                              ...
                                                              (!_lhsIvssGraph) ->
                                                                (case (({-# LINE 387 "./src-ag/InterfacesRules.lag" #-}
                                                                        Map.empty
                                                                        {-# LINE 648 "dist/build/InterfacesRules.hs" #-}
                                                                        )) of
                                                                 { !_lhsOinters ->
                                                                             ...
                                                                             sem_Interfaces_Nil_2 =
                                                                                 (T_Interfaces_2 (\ (!_lhsIallInters)
                                                                                                    (!_lhsIddp) ->
                                                                                                      (case (({-# LINE 437 "./src-ag/InterfacesRules.lag" #-}
                                                                                                              Seq.empty
                                                                                                              {-# LINE 657 "dist/build/InterfacesRules.hs" #-}
                                                                                                              )) of
                                                                                                       { !_lhsOedp ->
                                                                                                       (case (({-# LINE 388 "./src-ag/InterfacesRules.lag" #-}
                                                                                                               Map.empty
                                                                                                               {-# LINE 662 "dist/build/InterfacesRules.hs" #-}
                                                                                                               )) of
                                                                                                        { !_lhsOvisits ->
                                                                                                        ( _lhsOedp,_lhsOvisits) }) })))
    ...
    (T_Segment (\ (!_lhsIinfo)
                  (!_lhsIv) ->
                    (case (({-# LINE 106 "./src-ag/InterfacesRules.lag" #-}
                            \a -> ruleTable _lhsIinfo ! a
                            {-# LINE 791 "dist/build/InterfacesRules.hs" #-}
                            )) of
                     { !_look ->
                     (case (({-# LINE 109 "./src-ag/InterfacesRules.lag" #-}
                             \p us -> [ a  |  u <- us
                                           ...
                                           ,  p (_look a)]
                             {-# LINE 798 "dist/build/InterfacesRules.hs" #-}
                             )) of
                      { !_occurAs ->
                      (case (({-# LINE 113 "./src-ag/InterfacesRules.lag" #-}
                              ...
                              {-# LINE 804 "dist/build/InterfacesRules.hs" #-}
                              )) of
                       { !_groups ->
                       (case (({-# LINE 116 "./src-ag/InterfacesRules.lag" #-}
                               _lhsIv + length _groups
                               {-# LINE 809 "dist/build/InterfacesRules.hs" #-}
                               )) of
                        { !_v ->
                        (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                _v
                                {-# LINE 814 "dist/build/InterfacesRules.hs" #-}
                                )) of
                         { !_lhsOv ->
                                                                                  ...
                                                                                  (T_Segment_2 (\ (!_lhsIcons)
                                                                                                  ...
                                                                                                  (!_lhsIvssGraph) ->
                                                                                                    (case (({-# LINE 229 "./src-ag/InterfacesRules.lag" #-}
                                                                                                            ...
                                                                                                            {-# LINE 864 "dist/build/InterfacesRules.hs" #-}
                                                                                                            )) of
                                                                                                     { !_synOccur ->
                                                                                                     (case (({-# LINE 230 "./src-ag/InterfacesRules.lag" #-}
                                                                                                             ...
                                                                                                             {-# LINE 873 "dist/build/InterfacesRules.hs" #-}
                                                                                                             )) of
                                                                                                      { !_vss ->
                                                                                                      (case (({-# LINE 270 "./src-ag/InterfacesRules.lag" #-}
                                                                                                              map (\\ _lhsIprev) _vss
                                                                                                              {-# LINE 878 "dist/build/InterfacesRules.hs" #-}
                                                                                                              )) of
                                                                                                       { !_visitss' ->
                                                                                                       (case (({-# LINE 284 "./src-ag/InterfacesRules.lag" #-}
                                                                                                               ...
                                                                                                               in map (rem []) _visitss'
                                                                                                               {-# LINE 898 "dist/build/InterfacesRules.hs" #-}
                                                                                                               )) of
                                                                                                        { !_visitss ->
                                                                                                        (case (({-# LINE 271 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                ...
                                                                                                                {-# LINE 906 "dist/build/InterfacesRules.hs" #-}
                                                                                                                )) of
                                                                                                         { !_defined ->
                                                                                                         (case (({-# LINE 275 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                 _lhsIprev ++ _defined
                                                                                                                 {-# LINE 911 "dist/build/InterfacesRules.hs" #-}
                                                                                                                 )) of
                                                                                                          { !_lhsOprev ->
                                                                                                          (case (({-# LINE 409 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                  ...
                                                                                                                  {-# LINE 918 "dist/build/InterfacesRules.hs" #-}
                                                                                                                  )) of
                                                                                                           { !__tup1 ->
                                                                                                           (case (({-# LINE 409 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                   __tup1
                                                                                                                   {-# LINE 923 "dist/build/InterfacesRules.hs" #-}
                                                                                                                   )) of
                                                                                                            { !(_,!_synmap) ->
                                                                                                            (case (({-# LINE 409 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                    __tup1
                                                                                                                    {-# LINE 928 "dist/build/InterfacesRules.hs" #-}
                                                                                                                    )) of
                                                                                                             { !(!_inhmap,_) ->
                                                                                                             (case (({-# LINE 405 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                     ...
                                                                                                                     {-# LINE 933 "dist/build/InterfacesRules.hs" #-}
                                                                                                                     )) of
                                                                                                              { !_lhsOseg ->
                                                                                                                              ...
                                                                                                                              (T_Segment_3 (\ (!_lhsIallInters)
                                                                                                                                              ...
                                                                                                                                              (!_lhsInextIntravisits) ->
                                                                                                                                                (case (({-# LINE 357 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                        ...
                                                                                                                                                        {-# LINE 949 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                        )) of
                                                                                                                                                 { !_computed ->
                                                                                                                                                 (case (({-# LINE 356 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                         _occurAs isLhs inh_ ++ _lhsIfromLhs
                                                                                                                                                         {-# LINE 954 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                         )) of
                                                                                                                                                  { !_fromLhs ->
...
sem_Segments_Cons !(T_Segment hd_) !(T_Segments tl_) =
    (T_Segments (\ (!_lhsIinfo)
                   ...
                   (!_lhsIv) ->
                     (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                             _lhsIv
                             {-# LINE 1088 "dist/build/InterfacesRules.hs" #-}
                             )) of
                      { !_hdOv ->
                      (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                              _lhsIinfo
                              {-# LINE 1093 "dist/build/InterfacesRules.hs" #-}
                              )) of
                       { !_hdOinfo ->
                       (case (hd_ _hdOinfo _hdOv) of
                        { ( !_hdIv,!T_Segment_1 hd_1) ->
                            (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                    _hdIv
                                    {-# LINE 1100 "dist/build/InterfacesRules.hs" #-}
                                    )) of
                             { !_tlOv ->
                             (case (({-# LINE 83 "./src-ag/InterfacesRules.lag" #-}
                                     _lhsIinfo
                                     {-# LINE 1105 "dist/build/InterfacesRules.hs" #-}
                                     )) of
                              { !_tlOinfo ->
                              (case (({-# LINE 203 "./src-ag/InterfacesRules.lag" #-}
                                      _lhsIn
                                      {-# LINE 1110 "dist/build/InterfacesRules.hs" #-}
                                      )) of
                               { !_hdOn ->
                               (case (({-# LINE 207 "./src-ag/InterfacesRules.lag" #-}
                                       _lhsIn + 1
                                       {-# LINE 1115 "dist/build/InterfacesRules.hs" #-}
                                       )) of
                                { !_tlOn ->
                                (case (tl_ _tlOinfo _tlOn _tlOv) of
                                 { ( !_tlIdescr,!_tlIgroups,!_tlInewedges,!_tlInewvertices,!_tlIv,!T_Segments_1 tl_1) ->
                                     (case (({-# LINE 169 "./src-ag/InterfacesRules.lag" #-}
                                             _tlInewvertices
                                             {-# LINE 1122 "dist/build/InterfacesRules.hs" #-}
                                             )) of
                                      { !_hdOnextNewvertices ->
                                      (case (hd_1 _hdOn _hdOnextNewvertices) of
                                       { ( !_hdIdescr,!_hdIgroups,!_hdInewedges,!_hdInewvertices,!T_Segment_2 hd_2) ->
                                           (case (({-# LINE 130 "./src-ag/InterfacesRules.lag" #-}
                                                   _hdIdescr Seq.>< _tlIdescr
                                                   {-# LINE 1129 "dist/build/InterfacesRules.hs" #-}
                                                   )) of
                                            { !_lhsOdescr ->
                                            (case (({-# LINE 184 "./src-ag/InterfacesRules.lag" #-}
                                                    _hdIgroups
                                                    {-# LINE 1134 "dist/build/InterfacesRules.hs" #-}
                                                    )) of
                                             { !_lhsOgroups ->
                                             (case (({-# LINE 129 "./src-ag/InterfacesRules.lag" #-}
                                                     _hdInewedges Seq.>< _tlInewedges
                                                     {-# LINE 1139 "dist/build/InterfacesRules.hs" #-}
                                                     )) of
                                              { !_lhsOnewedges ->
                                              (case (({-# LINE 170 "./src-ag/InterfacesRules.lag" #-}
                                                      _hdInewvertices
                                                      {-# LINE 1144 "dist/build/InterfacesRules.hs" #-}
                                                      )) of
                                               { !_lhsOnewvertices ->
                                               (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                                       _tlIv
                                                       {-# LINE 1149 "dist/build/InterfacesRules.hs" #-}
                                                       )) of
                                                { !_lhsOv ->
                                                            ...
                                                            sem_Segments_Cons_1 =
                                                                (T_Segments_1 (\ (!_lhsIcons)
                                                                                 ...
                                                                                 (!_lhsIvssGraph) ->
                                                                                   (case (({-# LINE 216 "./src-ag/InterfacesRules.lag" #-}
                                                                                           _lhsIvssGraph
                                                                                           {-# LINE 1160 "dist/build/InterfacesRules.hs" #-}
                                                                                           )) of
                                                                                    { !_tlOvssGraph ->
                                                                                    (case (({-# LINE 125 "./src-ag/InterfacesRules.lag" #-}
                                                                                            _lhsIvisitDescr
                                                                                            {-# LINE 1165 "dist/build/InterfacesRules.hs" #-}
                                                                                            )) of
                                                                                     { !_tlOvisitDescr ->
                                                                                     (case (({-# LINE 216 "./src-ag/InterfacesRules.lag" #-}
                                                                                             _lhsIvssGraph
                                                                                             {-# LINE 1170 "dist/build/InterfacesRules.hs" #-}
                                                                                             )) of
                                                                                      { !_hdOvssGraph ->
                                                                                      (case (({-# LINE 125 "./src-ag/InterfacesRules.lag" #-}
                                                                                              _lhsIvisitDescr
                                                                                              {-# LINE 1175 "dist/build/InterfacesRules.hs" #-}
                                                                                              )) of
                                                                                       { !_hdOvisitDescr ->
                                                                                       (case (({-# LINE 263 "./src-ag/InterfacesRules.lag" #-}
                                                                                               _lhsIprev
                                                                                               {-# LINE 1180 "dist/build/InterfacesRules.hs" #-}
                                                                                               )) of
                                                                                        { !_hdOprev ->
                                                                                        (case (({-# LINE 235 "./src-ag/InterfacesRules.lag" #-}
                                                                                                _lhsIcons
                                                                                                {-# LINE 1185 "dist/build/InterfacesRules.hs" #-}
                                                                                                )) of
                                                                                         { !_hdOcons ->
                                                                                         (case (hd_2 _hdOcons _hdOprev _hdOvisitDescr _hdOvssGraph) of
                                                                                          { ( !_hdIprev,!_hdIseg,!T_Segment_3 hd_3) ->
                                                                                              (case (({-# LINE 263 "./src-ag/InterfacesRules.lag" #-}
                                                                                                      _hdIprev
                                                                                                      {-# LINE 1192 "dist/build/InterfacesRules.hs" #-}
                                                                                                      )) of
                                                                                               { !_tlOprev ->
                                                                                               (case (({-# LINE 235 "./src-ag/InterfacesRules.lag" #-}
                                                                                                       _lhsIcons
                                                                                                       {-# LINE 1197 "dist/build/InterfacesRules.hs" #-}
                                                                                                       )) of
                                                                                                { !_tlOcons ->
                                                                                                (case (tl_1 _tlOcons _tlOprev _tlOvisitDescr _tlOvssGraph) of
                                                                                                 { ( !_tlIsegs,!T_Segments_2 tl_2) ->
                                                                                                     (case (({-# LINE 400 "./src-ag/InterfacesRules.lag" #-}
                                                                                                             _hdIseg : _tlIsegs
                                                                                                             {-# LINE 1204 "dist/build/InterfacesRules.hs" #-}
                                                                                                             )) of
                                                                                                      { !_lhsOsegs ->
                                                                                                                  ...
                                                                                                                  sem_Segments_Cons_2 =
                                                                                                                      (T_Segments_2 (\ (!_lhsIallInters)
                                                                                                                                       ...
                                                                                                                                       (!_lhsIisFirst) ->
                                                                                                                                         (case (({-# LINE 341 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                 _lhsIddp
                                                                                                                                                 {-# LINE 1215 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                 )) of
                                                                                                                                          { !_tlOddp ->
                                                                                                                                          (case (({-# LINE 378 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                  _lhsIallInters
                                                                                                                                                  {-# LINE 1220 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                  )) of
                                                                                                                                           { !_tlOallInters ->
                                                                                                                                           (case (({-# LINE 341 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                   _lhsIddp
                                                                                                                                                   {-# LINE 1225 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                   )) of
                                                                                                                                            { !_hdOddp ->
                                                                                                                                            (case (({-# LINE 378 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                    _lhsIallInters
                                                                                                                                                    {-# LINE 1230 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                    )) of
                                                                                                                                             { !_hdOallInters ->
                                                                                                                                             (case (({-# LINE 354 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                     []
                                                                                                                                                     {-# LINE 1235 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                     )) of
                                                                                                                                              { !_tlOfromLhs ->
                                                                                                                                              (case (({-# LINE 353 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                      _lhsIfromLhs
                                                                                                                                                      {-# LINE 1240 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                      )) of
                                                                                                                                               { !_hdOfromLhs ->
                                                                                                                                               (case (({-# LINE 316 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                       False
                                                                                                                                                       {-# LINE 1245 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                       )) of
                                                                                                                                                { !_tlOisFirst ->
                                                                                                                                                (case (tl_2 _tlOallInters _tlOddp _tlOfromLhs _tlOisFirst) of
                                                                                                                                                 { ( !_tlIcvisits,!_tlIedp,!_tlIfirstInh,!_tlIhdIntravisits,!_tlIprev) ->
                                                                                                                                                     (case (({-# LINE 329 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                             _tlIhdIntravisits
                                                                                                                                                             {-# LINE 1252 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                             )) of
                                                                                                                                                      { !_hdOnextIntravisits ->
                                                                                                                                                      (case (({-# LINE 312 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                              _lhsIisFirst
                                                                                                                                                              {-# LINE 1257 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                              )) of
                                                                                                                                                       { !_hdOisFirst ->
                                                                                                                                                       (case (({-# LINE 446 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                               _tlIfirstInh
                                                                                                                                                               {-# LINE 1262 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                               )) of
                                                                                                                                                        { !_hdOnextInh ->
                                                                                                                                                        (case (hd_3 _hdOallInters _hdOddp _hdOfromLhs _hdOisFirst _hdOnextInh _hdOnextIntravisits) of
                                                                                                                                                         { ( !_hdIcvisits,!_hdIedp,!_hdIinh,!_hdIintravisits,!_hdIvisitss) ->
                                                                                                                                                             (case (({-# LINE 399 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                                     ...
                                                                                                                                                                     {-# LINE 1269 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                                     )) of
                                                                                                                                                              { !_lhsOcvisits ->
                                                                                                                                                              (case (({-# LINE 437 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                                      _hdIedp Seq.>< _tlIedp
                                                                                                                                                                      {-# LINE 1274 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                                      )) of
                                                                                                                                                               { !_lhsOedp ->
                                                                                                                                                               (case (({-# LINE 447 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                                       _hdIinh
                                                                                                                                                                       {-# LINE 1279 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                                       )) of
                                                                                                                                                                { !_lhsOfirstInh ->
                                                                                                                                                                (case (({-# LINE 330 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                                        _hdIintravisits
                                                                                                                                                                        {-# LINE 1284 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                                        )) of
                                                                                                                                                                 { !_lhsOhdIntravisits ->
                                                                                                                                                                 (case (({-# LINE 263 "./src-ag/InterfacesRules.lag" #-}
                                                                                                                                                                         _tlIprev
                                                                                                                                                                         {-# LINE 1289 "dist/build/InterfacesRules.hs" #-}
                                                                                                                                                                         )) of
                                                                                                                                                                  { !_lhsOprev ->
...
sem_Segments_Nil =
    (T_Segments (\ (!_lhsIinfo)
                   ...
                   (!_lhsIv) ->
                     (case (({-# LINE 130 "./src-ag/InterfacesRules.lag" #-}
                             Seq.empty
                             {-# LINE 1306 "dist/build/InterfacesRules.hs" #-}
                             )) of
                      { !_lhsOdescr ->
                      (case (({-# LINE 185 "./src-ag/InterfacesRules.lag" #-}
                              []
                              {-# LINE 1311 "dist/build/InterfacesRules.hs" #-}
                              )) of
                       { !_lhsOgroups ->
                       (case (({-# LINE 129 "./src-ag/InterfacesRules.lag" #-}
                               Seq.empty
                               {-# LINE 1316 "dist/build/InterfacesRules.hs" #-}
                               )) of
                        { !_lhsOnewedges ->
                        (case (({-# LINE 171 "./src-ag/InterfacesRules.lag" #-}
                                []
                                {-# LINE 1321 "dist/build/InterfacesRules.hs" #-}
                                )) of
                         { !_lhsOnewvertices ->
                         (case (({-# LINE 82 "./src-ag/InterfacesRules.lag" #-}
                                 _lhsIv
                                 {-# LINE 1326 "dist/build/InterfacesRules.hs" #-}
                                 )) of
                          { !_lhsOv ->
                                          ...
                                          (T_Segments_1 (\ (!_lhsIcons)
                                                           ...
                                                           (!_lhsIvssGraph) ->
                                                             (case (({-# LINE 401 "./src-ag/InterfacesRules.lag" #-}
                                                                     []
                                                                     {-# LINE 1337 "dist/build/InterfacesRules.hs" #-}
                                                                     )) of
                                                              { !_lhsOsegs ->
                                                                          ...
                                                                          sem_Segments_Nil_2 =
                                                                              (T_Segments_2 (\ (!_lhsIallInters)
                                                                                               ...
                                                                                               (!_lhsIisFirst) ->
                                                                                                 (case (({-# LINE 399 "./src-ag/InterfacesRules.lag" #-}
                                                                                                         []
                                                                                                         {-# LINE 1348 "dist/build/InterfacesRules.hs" #-}
                                                                                                         )) of
                                                                                                  { !_lhsOcvisits ->
                                                                                                  (case (({-# LINE 437 "./src-ag/InterfacesRules.lag" #-}
                                                                                                          Seq.empty
                                                                                                          {-# LINE 1353 "dist/build/InterfacesRules.hs" #-}
                                                                                                          )) of
                                                                                                   { !_lhsOedp ->
                                                                                                   (case (({-# LINE 448 "./src-ag/InterfacesRules.lag" #-}
                                                                                                           []
                                                                                                           {-# LINE 1358 "dist/build/InterfacesRules.hs" #-}
                                                                                                           )) of
                                                                                                    { !_lhsOfirstInh ->
                                                                                                    (case (({-# LINE 331 "./src-ag/InterfacesRules.lag" #-}
                                                                                                            repeat []
                                                                                                            {-# LINE 1363 "dist/build/InterfacesRules.hs" #-}
                                                                                                            )) of
                                                                                                     { !_lhsOhdIntravisits ->
                                                                                                     (case (({-# LINE 263 "./src-ag/InterfacesRules.lag" #-}
                                                                                                             _lhsIprev
                                                                                                             {-# LINE 1368 "dist/build/InterfacesRules.hs" #-}
                                                                                                             )) of
                                                                                                      { !_lhsOprev ->
                                                                                                      ( _lhsOcvisits,_lhsOedp,_lhsOfirstInh,_lhsOhdIntravisits,_lhsOprev) }) }) }) }) })))
