    ...
    (T_Alternative (\ _lhsIcr
                      ...
                      _lhsIuseMap ->
                        let _lhsOerrors :: (Seq Error)
                            ...
                            -- "DefaultRules.ag"(line 116, column 17)
                            (_childrenOcon@_) =
                                con_
                            -- "DefaultRules.ag"(line 115, column 17)
                            (_rulesOcon@_) =
                                con_
                            -- "DefaultRules.ag"(line 235, column 16)
                            (_lhsOerrors@_) =
                                _childrenIerrors <> _errs <> _rulesIerrors
                            -- "DefaultRules.ag"(line 197, column 20)
                            ((_newRls@_,_errs@_)) =
                                let locals       = _rulesIlocals
                                    ...
                                    rules      = concat rss
                                    constructor = getConName _lhsItypeSyns _lhsIo_rename _lhsInt con_
                                    (rules_lhs, errors2) = let (selfAttrs, normalAttrs) = Map.partition (==NT _SELF) _lhsIsyn
                                                               ...
                                                               selfLocRules  = let childSelf self nm tp = case tp of
                                                                               ...
                                                                               in [ makeRule (_LOC,attr)
                                                                                          (Expression noPos
                                                                                            (getConName _lhsItypeSyns _lhsIo_rename _lhsInt con_ ++ " " ++
                                                                                                  unwords [childSelf attr nm tp | (nm,tp) <- _childrenIfields]
                                                                                            )
                                                                                          )                                                                                                                                     "self rule"
                            ...
                            -- "DefaultRules.ag"(line 273, column 17)
                            (_lhsOout@_) =
    ...
    (T_Child (\ _lhsIcon
                ...
                _lhsInt ->
                  let _lhsOerrors :: (Seq Error)
                      ...
                      -- "DefaultRules.ag"(line 118, column 11)
                      (_lhsOname@_) =
                          name_
                      -- "DefaultRules.ag"(line 128, column 11)
                      (_lhsOsynthesized@_) =
                          syn_
                      -- "DefaultRules.ag"(line 127, column 11)
                      (_lhsOinherited@_) =
                          inh_
                      -- "DefaultRules.ag"(line 252, column 11)
                      (_lhsOfield@_) =
                          (name_,tp_)
                      -- use rule
                      (_lhsOerrors@_) =
    ...
    (T_Children (\ _lhsIcon
                   ...
                   _lhsInt ->
                     let _lhsOerrors :: (Seq Error)
                         ...
                         (_lhsOinputs@_) =
                             []
                         -- "DefaultRules.ag"(line 249, column 10)
                         (_lhsOfields@_) =
                             []
                         -- use rule
                         (_lhsOerrors@_) =
...
sem_Grammar_Grammar (typeSyns_) (useMap_) (derivings_) (wrappers_) ((T_Productions (prods_))) =
    (T_Grammar (\ _lhsIoptions ->
                    let _lhsOerrors :: (Seq Error)
                        ...
                        (_prodsOo_rename@_) =
                            rename    _lhsIoptions
                        -- "DefaultRules.ag"(line 96, column 13)
                        (_prodsOnonterminals@_) =
                            _prodsIcollect_nts
                        -- "DefaultRules.ag"(line 120, column 13)
                        (_prodsOuseMap@_) =
                            useMap_
    ...
    (T_Pattern (\ _lhsIcon
                  _lhsInt ->
                    let _lhsOcontainsVars :: (Bool)
                        ...
                        -- "DefaultRules.ag"(line 242, column 11)
                        (_lhsOlocals@_) =
                            if field_ == _LOC
                        ...
                        -- "DefaultRules.ag"(line 260, column 16)
                        (_lhsOcontainsVars@_) =
                            True
                        -- use rule
                        (_lhsOerrors@_) =
    ...
    (T_Production (\ _lhsIcr
                     ...
                     _lhsIuseMap ->
                       let _lhsOcollect_nts :: (Set Nonterminal)
                           ...
                           -- "DefaultRules.ag"(line 92, column 16)
                           (_lhsOcollect_nts@_) =
                               Set.single nt_
                           -- "DefaultRules.ag"(line 109, column 17)
                           (_altsOuseMap@_) =
                               Map.findWithDefault Map.empty nt_ _lhsIuseMap
                           -- "DefaultRules.ag"(line 108, column 17)
                           (_altsOsyn@_) =
                               syn_
                           -- "DefaultRules.ag"(line 107, column 17)
                           (_altsOinh@_) =
                               inh_
                           -- "DefaultRules.ag"(line 124, column 16)
                           (_altsOnt@_) =
                               nt_
                           -- use rule
                           (_lhsOerrors@_) =
                ...
                _lhsInt ->
                  let _lhsOdefinedAttrs :: (Set (Name,Name))
                      ...
                      ( _tlIdefinedAttrs,_tlIerrors,_tlIlocals,_tlIout) =
                          (tl_ (_tlOcon) (_tlOnt))
                      -- "DefaultRules.ag"(line 276, column 10)
                      (_lhsOout@_) =
